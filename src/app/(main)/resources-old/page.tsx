...
import { resourcesData, Resource } from '@/data/resourcesDataOld';
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-primary mb-4">Recursos (Antiguo)</h1>
        <p className="text-lg text-muted-foreground">Esta es la biblioteca de recursos estáticos original.</p>
      </div>
          ...
          <Card key={resource.id} className="shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col">
            ...
            <CardFooter>
              <Button asChild variant="outline" className="w-full">
                <Link href={`/resources-old/${resource.id}`}>
