...
// Las preguntas ahora están incrustadas directamente en el código para máxima fiabilidad.
...
export default function AssessmentPage() {
  // Las dimensiones ahora se obtienen de la constante local incrustada.
