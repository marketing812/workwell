...
export const assessmentInterpretations: Record<AssessmentDimension['id'], InterpretationLevels> = {
  'dim1': { // Regulación Emocional y Estrés
  ...
  'dim2': { // Flexibilidad Mental y Adaptabilidad
  ...
  'dim3': { // Autorregulación personal y constancia
  ...
  'dim4': { // Autoafirmación y Expresión Personal
  ...
  'dim5': { // Empatía y Conexión Interpersonal
  ...
  'dim7': { // Propósito Vital y Dirección Personal
  ...
  'dim9': { // Integridad y Coherencia Ética
  ...
  'dim10': { // Responsabilidad Personal y Aceptación Consciente
  ...
  'dim12': { // Valor Reconocido (Removed, but keeping an entry to prevent runtime errors if referenced)
    low: "Esta dimensión ya no se evalúa.",
    medium: "Esta dimensión ya no se evalúa.",
    high: "Esta dimensión ya no se evalúa.",
  }
};
