  ...
  modules: [
    {
      ...
      content: [
        { 
            ...
            text: '¿Alguna vez has pensado “mejor no molesto” o “ya me las apañaré” incluso cuando estabas agotado o agotada? Muchas personas sienten que pedir ayuda es sinónimo de debilidad, pero esta idea es un mito. En realidad, buscar apoyo es una señal de inteligencia emocional y de autocuidado.   El ser humano es una especie social por naturaleza. Según la neurociencia social (Lieberman, 2013), nuestro cerebro está literalmente “cableado” para la conexión, y las interacciones sociales positivas activan circuitos neuronales asociados al bienestar y la recompensa. Desde un punto de vista evolutivo, como muestran Cacioppo y Patrick (2008), sobrevivimos gracias a la cooperación: cuidarnos unos a otros aumentaba nuestras probabilidades de alimentarnos, defendernos y adaptarnos a cambios en el entorno.   Tener vínculos sólidos no solo es agradable: reduce el estrés, fortalece el sistema inmunitario y protege frente a la depresión y el deterioro cognitivo.    En esta semana vamos a explorar las creencias y miedos más comunes que nos frenan al pedir ayuda, para que puedas reconocerlas en ti y empezar a soltarlas.',
