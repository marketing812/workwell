  ...
  modules: [
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta10/sesion1/Audio1sesion1ruta10.mp3',
          content: [
            {
              type: 'paragraph',
        ...
        },
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta10/sesion1/Audio2sesion1ruta10.mp3',
          content: [
            {
              type: 'paragraph',
        ...
        },
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta10/sesion1/Audio3sesion1ruta10.mp3',
          content: [
            {
              type: 'paragraph',
        ...
        },
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta10/sesion1/Audio4sesion1ruta10.mp3',
          content: [
            {
              type: 'paragraph',
        ...
        },
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta10/sesion1/Audio5sesion1ruta10.mp3',
          content: [
            {
              type: 'paragraph',
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'collapsible',
          title: 'El poder de tu voz interna',
          content: [
            {
              type: 'paragraph',
              text: 'Tu diálogo interno influye directamente en tu motivación y en cómo gestionas los errores. Un lenguaje interno amenazante activa el sistema de estrés, mientras que una voz amable activa la autorregulación.',
            },
          ],
        },
        {
          type: 'collapsible',
          title: 'Responsabilidad vs. Autoexigencia destructiva',
          content: [
            {
              type: 'paragraph',
              text: 'La responsabilidad busca reparar y aprender. La autoexigencia destructiva se enfoca en el castigo y la autocrítica. La investigación de Kristin Neff demuestra que la autocompasión es más efectiva para la persistencia que la crítica severa.',
            },
          ],
        },
        {
          ...
          content: [
            {
              type: 'paragraph',
              text: 'Vamos a entrenar tu voz interna para que pase de juez severo a guía firme y alentador. No se trata de evitar la responsabilidad, sino de decir las cosas de forma que te ayuden a actuar.',
            },
          ],
        },
        { type: 'title', text: 'Técnicas Específicas' },
