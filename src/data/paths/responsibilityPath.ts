  ...
  modules: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'selfAcceptanceAudioExercise', title: 'EJERCICIO 2: PRÁCTICA DE AUTOACEPTACIÓN GUIADA', objective: 'Entrenar la autoaceptación para reconocer lo que pasó sin castigo, tratándote con la misma amabilidad que tendrías con alguien querido.', duration: '7–10 min', audioUrl: 'https://workwellfut.com/audios/rm/R10_practica_auto_aceptación_Guiada.mp3' },
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        { type: 'collapsible', title: 'De cargar con todo a elegir con intención', content: [{ type: 'paragraph', text: 'Hacerse cargo sin perderte de vista significa actuar desde la responsabilidad activa sin absorber culpas o problemas ajenos. Se trata de elegir dónde pones tu energía.' }] },
