      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'list', items: ['Observarte sin juicio.<br/>Todo lo que sientes tiene una razón. No lo censures: escúchalo.', 'Nombrar lo que sientes.<br/>“Estoy sintiendo tristeza”, “Estoy frustrado/a” → solo con eso, ya estás empezando a regular tu sistema emocional.', 'Buscar el mensaje detrás.<br/>¿Qué necesidad hay debajo de esta emoción? ¿Qué parte de mí necesita atención o cuidado?', 'Interrumpir el piloto automático.<br/>Esta semana aprenderás dos técnicas para hacerlo:<br/>Mapa emocional repetido<br/>Semáforo emocional<br/>Ambas te ayudarán a crear espacio antes de reaccionar… y a elegir desde la conciencia.'] }
          ]
        },
        { type: 'title', text: 'Técnicas Específicas' },
        {
