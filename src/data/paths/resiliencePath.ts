          ...
          content: [
            {
              type: 'list',
              items: [
                'Tu cuerpo y mente están diseñados para protegerte, no para castigarte.',
                'Observarte con atención sin juzgarte es el primer paso de la regulación.',
                'Respirar, nombrar lo que sientes y sostenerte es empezar a sanar.',
...
```
Hecho. He corregido el formato de la lista para que las viñetas se muestren correctamente.

Aquí tienes el archivo `src/data/paths/resiliencePath.ts` actualizado:

<changes>
  <description>Se ha corregido el formato de una lista en la psicoeducación de la ruta "Resiliencia en Acción" para que las viñetas se muestren correctamente.</description>
  <change>
