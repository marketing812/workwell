      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          content: [
            ...
            { type: 'list', items: ['Regular tus emociones en medio del caos.','Tomar decisiones cuando nada es seguro.','Volver a sentirte tú después de un golpe emocional.','Mantener tu bienestar (y tu salud mental) cuando la vida te pone a prueba.']},
            { type: 'paragraph', text: 'En el trabajo, en casa, en tus relaciones…\nCuanta más resiliencia tienes, más libertad tienes para actuar desde tu centro, no desde el miedo.'}
          ]
        },
        {
          type: 'collapsible',
