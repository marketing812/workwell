  ...
  modules: [
    {
      ...
      content: [
        ...
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana1/REFLEXION.mp3', prompts: ['<ul><li>Lo que he aprendido sobre mí: (Escribe aquí 2-3 ideas clave que te lleves de esta semana)</li><li>Consecuencias de no cuidar mi coherencia: (Anota qué pasa si no haces nada para alinear lo que piensas, sientes y haces)</li><li>Ventajas de vivir con coherencia personal: (Enumera los beneficios que te inspira buscar esta alineación)</li><li>Mi compromiso para esta semana: (Define un gesto concreto para acercarte a tu coherencia)</li></ul>']},
