  ...
  modules: [
      ...
      content: [
        {
          ...
          audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana1/INTRODUCCIONSEMANA1.mp3'
        },
        ...
        { 
          ...
          prompts: [
            '<p>Esta semana has explorado qué significa para ti vivir en coherencia, dónde la sientes y dónde no tanto. Vamos a aterrizar lo que has descubierto.</p><ul><li><p>Lo que he aprendido sobre mí:</p><p class="text-xs text-muted-foreground">(Escribe aquí 2-3 ideas clave que te lleves de esta semana)</p><p class="text-xs text-muted-foreground italic">Ejemplo: “Me he dado cuenta de que en mis relaciones soy coherente, pero en el trabajo suelo callar lo que pienso.”</p></li><li><p>Consecuencias de no cuidar mi coherencia:</p><p class="text-xs text-muted-foreground">(Anota qué pasa si no haces nada para alinear lo que piensas, sientes y haces)</p><p class="text-xs text-muted-foreground italic">Ejemplo: “Me siento agotada, con menos motivación y más frustrada.”</p></li><li><p>Ventajas de vivir con coherencia personal:</p><p class="text-xs text-muted-foreground">(Enumera los beneficios que te inspira buscar esta alineación)</p><p class="text-xs text-muted-foreground italic">Ejemplo: “Me siento más ligera, segura y con energía para lo que importa.”</p></li><li><p>Mi compromiso para esta semana:</p><p class="text-xs text-muted-foreground">(Define un gesto concreto para acercarte a tu coherencia)</p><p class="text-xs text-muted-foreground italic">Ejemplo: “Decir que no a una petición que no puedo atender sin sentirme culpable.”</p></li></ul>'
          ]
        },
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Tomar decisiones que te representen no es siempre lo más fácil… pero sí lo más auténtico. Esta semana aprenderás a identificar los valores que quieres sostener y a usarlos como brújula para decidir, incluso cuando haya dudas o presiones externas. Porque cuando sabes qué es importante para ti, es más fácil decir ‘sí’ o ‘no’ sin sentirte en deuda contigo mismo o contigo misma.', audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana2/INTRODUCCIONSEMANA2.mp3' },
        ...
        { type: 'collapsible', title: 'Señales de que algo está desalineado', audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana2/Senalesdequealgoestadesalineado.mp3', content: [{ type: 'paragraph', text: 'Ahora que ya conoces las fuerzas que generan incoherencia, vamos a ver cómo se manifiesta en tu día a día. Estas señales son como luces de advertencia en un coche: no son el problema, pero indican que conviene parar y revisar.' }, { type: 'list', items: ['Fatiga moral: ese cansancio que no es físico, sino emocional, por actuar contra lo que valoras. Por ejemplo, decir que sí a un proyecto que no quieres, solo para no decepcionar.','Incomodidad emocional persistente: una especie de “ruido de fondo” interno que aparece después de ciertas decisiones, aunque en el momento parecieran correctas.','Autojustificación excesiva: dar mil razones para convencerte de que “no estuvo tan mal” lo que hiciste, aunque en el fondo sabes que no es lo que querías.','Sensación de estancamiento: la impresión de vivir en un bucle, repitiendo las mismas decisiones y errores sin avanzar.'] }, { type: 'paragraph', text: 'Si reconoces alguna de estas señales, no te alarmes. No indican que “estés roto/a”, sino que hay un desajuste entre tu brújula interna y tu dirección actual. Y la buena noticia es que puedes recalibrarla.' }] },
        ...
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana2/REFLEXION.mp3', prompts: ['<ul><li>¿Qué he aprendido sobre mí esta semana?</li><li>¿Qué pasa en mi vida cuando no actúo en coherencia?</li><li>¿Qué ventajas noto cuando alineo lo que pienso, siento y hago?</li><li>¿Qué compromiso personal me llevo?</li></ul>'] },
        { type: 'title', text: 'Resumen Clave' },
