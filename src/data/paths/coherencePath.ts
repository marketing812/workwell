  ...
  modules: [
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Tomar decisiones que te representen no es siempre lo más fácil… pero sí lo más auténtico. Esta semana aprenderás a identificar los valores que quieres sostener y a usarlos como brújula para decidir, incluso cuando haya dudas o presiones externas. Porque cuando sabes qué es importante para ti, es más fácil decir ‘sí’ o ‘no’ sin sentirte en deuda contigo mismo o contigo misma.', audioUrl: 'https://workwellfut.com/audios/ruta9/descripciones/semana2/INTRODUCCIONSEMANA2.mp3' },
        ...
        { type: 'list', items: ['Detectar tus puntos de desconexión interna te da información valiosa sobre tus necesidades y límites.','Pensamiento, emoción y acción funcionan como un equipo: si uno se descuida, todo el equilibrio se resiente.','La coherencia no significa rigidez: a veces elegir lo contrario a lo que sientes es válido, si responde a un valor importante para ti.','Observarte sin juicio abre espacio para el cambio y la autoaceptación.'] }, { type: 'quote', text: '“La coherencia no es perfección, es respeto hacia lo que eres. Cada vez que piensas, sientes y actúas en la misma dirección, fortaleces tu brújula interna.”' }]
    },
    {
      id: 'coherencia_sem3',
