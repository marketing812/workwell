  ...
  modules: [
        ...
        content: [
            ...
            { type: 'paragraph', text: '¿Te ha pasado alguna vez que estás nervioso/a, con la cabeza llena de cosas, y de pronto respiras más lento o te estiras… y sientes que algo empieza a aflojarse por dentro?\nEso no es casualidad: es tu cuerpo haciendo su parte para ayudarte a recuperar la calma.\nY es que no solo la mente participa en la gestión del estrés. Tu cuerpo tiene un papel clave. Muchas veces, aunque tú quieras estar tranquilo/a, tu cuerpo reacciona como si estuvieras en medio de una emergencia.' },
            {
                ...
                content: [
                    ...
                    { type: 'paragraph', text: 'Rama simpática: tu sistema de alarma\nEsta es la parte que se enciende cuando algo se percibe como una amenaza. Y no hace falta que sea un peligro real. El cuerpo no distingue entre un león y un correo urgente: si tu sistema cree que algo puede salir mal, activa la alarma igual.\nEn ese momento, tu corazón se acelera, respiras más rápido, tus músculos se tensan… Es tu cuerpo preparándose para “luchar o huir”. A corto plazo, esta reacción puede ayudarte a resolver un problema. Pero si se mantiene encendida mucho tiempo, te agota, te desconecta y puede dejar encendida la ansiedad.' },
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'title', text: 'Técnicas Específicas'},
            { type: 'exercise', title: 'Ejercicio 1: Detective de Pensamientos Estresantes', objective: 'En este ejercicio vas a convertirte en un detective de tu propia mente. Aprenderás a observar esos pensamientos automáticos que te sobrecargan, detectar los filtros que distorsionan tu percepción y reformularlos con una mirada más realista, flexible y amable. Esto fortalecerá tu conciencia emocional y te ayudará a regular ese diálogo interno que, a veces, se vuelve demasiado exigente.', content: [
                { type: 'paragraph', text: 'Formato app: Registro guiado paso a paso con preguntas interactivas.'},
                { type: 'paragraph', text: 'Pasos del ejercicio:\n1.\tSituación: ¿Qué ocurrió? Ej: “Tenía que presentar un informe y mi hijo se puso enfermo.”\n2.\tPensamiento automático: ¿Qué pasó por tu mente? Ej: “No voy a poder con todo.”\n3.\tDistorsión cognitiva: Elige del desplegable.\n4.\tEmoción asociada: Elige del desplegable del Diccionario de Emociones\n5.\tPreguntas de verificación: \n¿Es 100% cierto? [Campo libre]\n¿Estoy anticipando? [Campo libre]\n¿Qué me diría alguien que me quiere? [Campo libre]\n6.\tPensamiento alternativo: Reformula con realismo y autocompasión.\n[Campo libre]'}
            ]},
            { type: 'exercise', title: 'Ejercicio 2: Tabla de Exigencias vs. Deseos Reales', objective: 'En este ejercicio vas a observar con honestidad tus propias exigencias internas y diferenciarlas de tus verdaderos deseos y necesidades. Aprenderás a soltar los "debería" que te presionan y a reformularlos con una mirada más compasiva. Este proceso te ayudará a liberar tu mente del exceso de autoexigencia y a reconectar con una forma de cuidarte más humana, realista y sostenible.', content: [
                { type: 'paragraph', text: 'Formato app: Tabla interactiva con ejemplos y guía paso a paso.'},
                { type: 'paragraph', text: 'Pasos del ejercicio:\n1.\tExigencia detectada: ¿Qué te estás diciendo? Escríbelo tal como aparece en tu mente, sin filtro.\nEjemplo: “Tengo que estar siempre disponible para todos, aunque no pueda más.”\n[Campo libre]\n2.\tOrigen probable: Marca una o varias opciones que creas que influyen en esa exigencia:\no\t☐ Familia o educación\no\t☐ Cultura o sociedad\no\t☐ Miedo al rechazo\no\t☐ Deseo de aprobación\no\t☐ Inseguridad personal\no\t☐ Otra: ____________________________\n3.\tConsecuencias: ¿Qué te está costando esta exigencia? Piensa en el impacto emocional, físico o en tus relaciones.\nEjemplo: “Me siento agotada, irritable y con culpa por no disfrutar de nada.”\n[Campo libre]\n4.\tDeseo o necesidad real: ¿Qué es lo que verdaderamente necesitas o quieres en esta situación, más allá de la exigencia que te estás imponiendo? Intenta conectar con tu parte más honesta y cuidadora.\nEjemplo: “Necesito descansar, sentirme comprendida y darme permiso para no estar siempre disponible.”\n[Campo libre]\n5.\tReformulación compasiva: ¿Qué podrías decirte desde una mirada más humana, flexible y comprensiva?\nEjemplo: “Estoy haciendo lo mejor que puedo. No tengo que poder con todo. También merezco cuidarme.”\n[Campo libre]'}
            ]},
            { type: 'title', text: 'Resumen Clave' },
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'title', text: 'Técnicas Específicas'},
            { type: 'exercise', title: 'Ejercicio 1: Diseña tu Plan de Bienestar Emocional', objective: 'Esta técnica te ayuda a crear un plan práctico y realista para prevenir recaídas. Vas a identificar tus señales personales de sobrecarga, elegir las estrategias que mejor te funcionan y definir rutinas mínimas de cuidado diario. El objetivo es que salgas de esta ruta sabiendo cómo cuidarte mejor en los momentos difíciles, aumentando así tu sensación de control, seguridad y confianza personal.', content: [
                { type: 'paragraph', text: 'Formato app: Registro guiado paso a paso con campos seleccionables y editables.'},
                { type: 'paragraph', text: 'Pasos del ejercicio:\n1.\tMis señales de alerta personal ¿Qué me indica que estoy empezando a sobrecargarme?\nCampo libre para completar + opción de seleccionar entre señales comunes.\nSeñales comunes de sobrecarga: (Selecciona todas las que reconozcas en ti. También puedes añadir otras en el campo libre.)\nCognitivas / mentales\n☐ Me cuesta concentrarme\n☐ Tengo pensamientos en bucle\n☐ Siento que no llego a todo, por más que haga\n☐ Me pongo muy autoexigente o perfeccionista\n☐ Me cuesta tomar decisiones\n☐ Señales propias [Campo libre]\nConductuales\n☐ Evito tareas, conversaciones o compromisos\n☐ Empiezo a procrastinar más de lo habitual\n☐ Me desconecto de lo que me importa\n☐ Estoy más irritable o impaciente\n☐ Me vuelvo muy complaciente con los demás, incluso cuando no quiero\n☐ Señales propias [Campo libre]\nEmocionales\n☐ Me siento más irritable, ansioso/a o frustrado/a\n☐ Me noto más apático/a o desconectado/a\n☐ Me invade la culpa si no estoy siendo “productivo/a”\n☐ Lloro con facilidad o me cuesta expresar lo que siento\n☐ Siento que todo me supera o me siento desbordado/a\n☐ Señales propias [Campo libre]\nFísicas / fisiológicas\n☐ Duermo mal o me cuesta conciliar el sueño\n☐ Me levanto ya cansado/a o sin energía\n☐ Tengo dolores musculares o tensión en cuello/espalda\n☐ Se me corta el apetito o como por ansiedad\n☐ Me cuesta respirar profundo o noto el pecho cerrado\n☐ Señales propias [Campo libre]\nCampo libre: ¿Qué señales propias reconoces en ti cuando estás empezando a sobrecargarte?\nEjemplos: “Empiezo a dormir mal”, “Me desconecto emocionalmente”, “Evito tareas o conversaciones”.\n2.\tMis técnicas de regulación favoritas ¿Qué estrategias me ayudan a volver a mi centro?\n☐ Respiración diafragmática\n☐ Escaneo corporal\n☐ Paseo breve sin distracciones\n☐ Frase ancla: “Estoy en un momento difícil, pero puedo afrontarlo.”\n☐ Autorregistro (escribir lo que pienso, siento y hago)\n☐ Reestructuración de pensamientos estresantes\n☐ Otra: [campo libre]\n3.\tMínimos no negociables (rutinas de autocuidado) ¿Qué necesito mantener cada día para estar bien?\n(Selecciona los que apliquen o añade el tuyo propio)\n☐ Dormir al menos 7 horas\n☐ Comer sin pantallas\n☐ Hacer pausas reales durante el día\n☐ Practicar una técnica de regulación emocional\n☐ Mantener contacto afectivo con alguien de confianza\n☐ Tiempo sin móvil o redes sociales\n☐ Otra: [campo libre]\n4.\tMi red de apoyo emocional ¿A quién puedo acudir si me siento sobrepasada/o?\n☐ Amistad cercana\n☐ Pareja / familiar\n☐ Profesional\n☐ Grupo o espacio seguro\n☐ Otra: [campo libre]\n5.\tPlan personal para momentos críticos ¿Qué haré si vuelvo a sentirme al límite?\nEjemplo: “Si noto que me desbordo, me daré 5 minutos de pausa, escribiré lo que siento, usaré una técnica de respiración y hablaré con alguien antes de decidir o actuar.”\nCampo libre guiado + opción de guardar como recordatorio.'}
            ]},
