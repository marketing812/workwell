      ...
      content: [
          {
              ...
              audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana3/INTRODUCCIONSEMANA3.mp3`,
          },
          { type: 'title', text: 'Psicoeducación' },
          {
              type: 'collapsible',
          ...
          },
          {
            type: 'therapeuticNotebookReflection',
            title: 'Reflexión Final de la Semana',
            audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana3/REFLEXION.mp3`,
            prompts: [
          ...
          { type: 'title', text: 'Resumen Clave de la Semana', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana3/RESUMEN.mp3`},
        ...
        content: [
            {
              ...
              audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana4/INTRODUCCIONSEMANA4.mp3`,
            },
            { type: 'title', text: 'Psicoeducación' },
            {
                type: 'collapsible',
            ...
            },
            {
              type: 'therapeuticNotebookReflection',
              title: 'Reflexión Final de la Semana',
              audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana4/REFLEXION.mp3`,
              prompts: ['¿Qué me ayuda a volver a mi centro cuando me siento desbordado/a?'],
            },
            { type: 'title', text: 'Resumen Clave de la Semana', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/semana4/RESUMEN.mp3` },
      ...
      content: [
          {
            ...
            audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/REFLEXIONRUTA.mp3`,
            prompts: [
              '<p>Has llegado al final de la Ruta. Reconócete el trabajo hecho. Has aprendido qué es el estrés, cómo funciona en ti, de qué formas puedes gestionarlo y has elaborado un plan para afrontarlo cada vez que aparezca.</p><p>Vamos ahora, a pasar a la reflexión final.</p><p><br></p><p>¿Qué me ha enseñado esta ruta sobre mí misma/o que no quiero olvidar?</p>',
            ]
          },
          {
            type: 'title',
            text: 'Resumen Final de la Ruta',
            audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta1/RESUMENRUTA.mp3`
          },
          {
            type: 'list',
            items: [
