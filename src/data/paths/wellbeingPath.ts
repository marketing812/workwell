    ...
    },
    {
      ...
      content: [
          ...
          content: [
            ...
            },
            {
              ...
              items: [
                'Dormimos peor.',
                'Nos movemos menos.',
                'Comemos rápido o poco nutritivo.',
              ],
            },
            {
              type: 'paragraph',
              text: 'Esto aumenta la vulnerabilidad física y emocional. En psicología lo llamamos un bucle de vulnerabilidad: cuanto peor te sientes, menos haces lo que te cuida, y cuanto menos te cuidas, peor te sientes.   Volver a hábitos que nos cuidan no solo aporta estructura y previsibilidad: le devuelve a tu cuerpo y a tu mente la sensación de seguridad, y eso es la base para tomar mejores decisiones y recuperar energía.',
            },
          ],
        },
        {
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        {
          ...
          objective:
            'Este ejercicio te ayudará a elegir un microhábito físico, uno emocional y uno mental que puedas mantener incluso en días ocupados o difíciles, para que actúen como anclas que sostengan tu bienestar.',
          duration: '6-8 min',
        ...
        },
        {
          ...
          objective:
            'Tus primeras acciones al despertar marcan el tono de todo lo que viene después. En este ejercicio vas a diseñar una rutina inicial breve que te permita aterrizar en tu día con presencia y equilibrio.',
          duration: '8-10 min',
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        {
          ...
          objective:
            'Con este ejercicio vas a descubrir las tres capas que dan fuerza a la motivación: lo que haces, por qué lo haces y para qué mayor lo haces. Al completarla, tendrás un recordatorio claro que te ayudará a empezar incluso en días de poca energía.',
          duration: '7 min',
        ...
        },
        {
          ...
          objective:
            'Con este ejercicio vas a diseñar mentalmente el día que quieres vivir, conectándolo con sensaciones y comportamientos que te acerquen a tu mejor versión. Al practicarlo, tu mente y tu cuerpo se preparan para vivir lo que has imaginado.',
          duration: '5-7 min',
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        {
          ...
          objective:
            'Este ejercicio te ayudará a entrenar tu mente para equilibrar el “sesgo negativo” natural del cerebro, capturando y conservando los momentos que te nutren para que puedas revivirlos en días difíciles.',
          duration: '10-12 min',
