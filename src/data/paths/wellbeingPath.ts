...
export const wellbeingPath: Path = {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Eventos de vida y estrés: pérdidas, cambios importantes, problemas continuos.", "Manera de pensar: creencias aprendidas y patrones de pensamiento que amplifican lo negativo y minimizan lo positivo.", "Relaciones: entornos críticos, poco apoyo o vínculos que drenan tu energía.", "Factores biológicos: cambios en neurotransmisores como la serotonina o la dopamina, que afectan tu motivación y capacidad de disfrutar.", "Hábitos y estilo de vida: falta de sueño, poca actividad física, alimentación desequilibrada."]
            },
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Tu cerebro emocional (amígdala) envía señales de alerta constantes, activando tensión y cansancio.", "Tu cerebro pensante (corteza prefrontal) pierde un poco de claridad y energía para planificar o decidir.", "Tus músculos, tu respiración y tu postura cambian, enviando mensajes silenciosos de que “todo pesa más”."]
            },
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Se alimenta de combustible físico (descanso, alimentación, movimiento).", "Necesita chispa emocional (momentos que te hagan sentir vivo/a).", "Y se mantiene con aire mental (propósitos, curiosidad, retos alcanzables)."]
            },
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Dopamina: la chispa que te mueve a actuar.", "Núcleo accumbens: el radar de lo que puede hacerte sentir bien.", "Corteza prefrontal: la que decide si vas hacia lo que de verdad importa o hacia lo que solo alivia un rato."]
            },
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Retomar algo que antes disfrutabas.", "Probar una versión más pequeña de una actividad que te gustaba.", "Buscar compañía que te aporte calma o risa."]
            },
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Dormimos peor.", "Nos movemos menos.", "Comemos rápido o poco nutritivo."]
            },
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'La Terapia Cognitivo-Conductual y la psicología del hábito coinciden: no necesitas un cambio radical para notar mejoras.' },
            {
              type: 'list',
              items: ["Moverte 10 minutos al día.", "Preparar un desayuno nutritivo.", "Reservar un rato para algo que disfrutas."]
            },
            { type: 'paragraph', text: 'Estos gestos, aunque parezcan mínimos, generan una sensación de logro que alimenta tu motivación. En palabras de BJ Fogg, experto en hábitos, “el cambio se crea sintiéndote bien con lo que haces, no castigándote por lo que no haces”.' }
          ]
        },
        {
          type: 'collapsible',
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Un deseo de cambiar cómo nos sentimos (relajarnos, tener más energía, ganar claridad mental).", "Una emoción que nos impulsa: incluso las decisiones más “lógicas” tienen un fondo emocional.", "La anticipación de una recompensa: imaginar lo bien que nos sentiremos después activa la dopamina en el cerebro, una sustancia que nos empuja a actuar."]
            },
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'En etapas de ánimo bajo o depresión, es común perder la motivación positiva: sabemos lo que hay que hacer, pero sentimos que no tenemos energía. Esto puede deberse a:' },
            {
              type: 'list',
              items: ["Pensamientos que desaniman (“es inútil intentarlo”, “no soy capaz”).", "Cansancio físico o mental.", "No tener claro cuándo, cómo o dónde empezar.", "Perfeccionismo: esperar el momento o las condiciones perfectas para actuar.", "Falta de conexión emocional con la tarea.", "Estrés o entornos poco estimulantes que reducen la motivación."]
            },
            { type: 'paragraph', text: 'Estos bloqueos pueden sentirse como un muro… pero, como todo muro, se puede saltar, rodear o derribar. El primer paso es saber que sí se puede actuar incluso sin ganas, y que existen estrategias para lograrlo.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            { type: 'paragraph', text: 'Si esperamos a “tener ganas” para movernos, podemos quedarnos atrapados en la inacción. La clave está en aprender a actuar incluso cuando la motivación está baja, usando tres apoyos:' },
            {
              type: 'list',
              items: ["Disciplina: seguir adelante por compromiso con nuestros objetivos, no por un impulso momentáneo.", "Planificación clara: decidir de antemano cuándo y dónde haremos algo reduce las dudas y evita que lo posterguemos.", "Facilidad: ponértelo tan fácil que sea casi imposible no empezar (en terapia lo llamamos “bajar la rampa”)."]
            },
            { type: 'paragraph', text: 'Así, el primer paso requiere muy poca energía y es más probable que lo des. Pero tan importante como cómo te pones en marcha, es desde dónde lo haces.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            { type: 'paragraph', text: 'La forma en la que te hablas cambia cómo percibes una tarea:' },
            {
              type: 'list',
              items: ["“Tengo que”: suena a obligación, activa resistencia y nos lleva a evitar o postergar. Además, si no cumplimos los “tengo que”, luego nos sentimos muy mal.", "“Quiero” o “elijo”: conecta con lo que valoras y despierta motivación propia."]
            },
            { type: 'paragraph', text: 'Ejemplo: “Tengo que hacer ejercicio” → “Quiero moverme para sentirme con más energía y cuidar mi salud”.\n\nEste cambio no es solo de palabras: también modifica cómo el cerebro procesa la tarea, activando zonas relacionadas con el sentido y la recompensa.\nY para que este cambio no se quede en palabras bonitas, vamos a conectar cada acción con algo más profundo: su valor y su sentido.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Acción concreta: lo que harás hoy.", "Valor personal: por qué eso es importante para ti.", "Sentido mayor: cómo encaja con la vida que quieres construir."]
            },
            { type: 'paragraph', text: 'Por ejemplo: “Hoy voy a salir a caminar (acción concreta) porque valoro mi bienestar físico (valor personal) y quiero tener energía para jugar con mis hijos (sentido mayor)”.   Cuantas más capas actives, más fuerte será tu impulso para empezar y mantenerte.  Incluso así, iniciar puede costar. Aquí es donde las microacciones se convierten en tu mejor aliado.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Si no haces nada: menos satisfacción o sensación de logro → menos ganas → más bloqueo.", "Si das un paso (aunque pequeño): más satisfacción o logro → más ganas → más acción."]
            },
        ...
        },
        {
          ...
          title: 'EJERCICIO 2: Visualización: El Día que Elijo Vivir',
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'list',
              items: ["Hábitos: acciones diarias que favorecen el bienestar.", "Relaciones: vínculos que nos sostienen y nos nutren emocionalmente.", "Actitudes: la forma en que interpretamos y respondemos a lo que ocurre."]
            }
          ]
        },
        {
  ...
  ]} module={"id":"bienestar_sem2","title":"Semana 2: Recupera Rutinas que te Nutran","type":"skill_practice","estimatedTime":"15-20 min","content":[{"type":"paragraphWithAudio","text":"Cuando estamos bajos de ánimo, lo primero que suele romperse es lo más básico: dormir bien, comer con calma, mover el cuerpo. Esto aumenta el malestar y nos deja más vulnerables. Esta semana aprenderás a reinstalar pequeños rituales de cuidado —microhábitos físicos, emocionales y mentales— que actúan como anclas en tu día. No se trata de hacer todo perfecto, sino de tener gestos breves, amables y repetidos que te devuelvan estabilidad y energía.","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Introsesion2ruta12.mp3"},{"type":"title","text":"Psicoeducación"},{"type":"collapsible","title":"Cuando lo básico empieza a fallar","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio1sesion2ruta12.mp3","content":[{"type":"paragraph","text":"¿Te ha pasado que, en momentos difíciles, lo primero que se desordena es lo que te sostiene?  Dormimos peor, comemos rápido, dejamos de movernos… y, sin darnos cuenta, el malestar crece.   Esta semana vamos a volver a lo esencial: recuperar esas rutinas que te alimentan por dentro y por fuera, que estabilizan tus días y te devuelven energía. No hablamos de forzarte a hacer todo perfecto, sino de crear pequeños anclajes que te ayuden a sentirte más estable y con más fuerza para afrontar lo que venga."}]},{"type":"collapsible","title":"Rutinas que son anclas","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio2sesion2ruta12.mp3","content":[{"type":"paragraph","text":"Las rutinas saludables no son simples tareas repetidas: son anclas emocionales que estabilizan tu día, regulan tu estado de ánimo y alimentan tu motivación. Desde la neurociencia del estrés sabemos que cuando cuidas lo básico —alimentación, descanso y movimiento— tu sistema nervioso interpreta que estás a salvo, lo que reduce la sobreactivación de la amígdala (la “alarma” emocional) y te ayuda a pensar con más claridad. Si además incluyes actividades que disfrutas y te hacen sentir logro —como caminar, bailar, cocinar algo rico o retomar un hobby—, activas circuitos de recompensa que liberan dopamina y serotonina, potenciando tu bienestar y tu motivación."}]},{"type":"collapsible","title":"El papel de las rutinas en tu equilibrio emocional","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio3sesion2ruta12.mp3","content":[{"type":"paragraph","text":"Recuperar rutinas que te nutren no solo mejora tu energía física: fortalece tu estabilidad emocional. Las acciones que repites cada día actúan como un hilo conductor que te ayuda a mantener el rumbo incluso cuando hay turbulencias. Cuando estás en tus rutinas de cuidado: pones nombre a lo que sientes, aceptas sin juicio y eliges cómo responder. Esto te da más claridad y paz mental. Además, practicar habilidades como la asertividad, la solución de problemas o el mindfulness, según Jon Kabat-Zinn, reduce la reactividad automática y te ayuda a mantenerte centrado/a incluso en momentos difíciles."}]},{"type":"collapsible","title":"Cuando las rutinas se rompen","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio4sesion2ruta12.mp3","content":[{"type":"paragraph","text":"En momentos duros, solemos descuidar justo lo que más nos sostiene:"},{"type":"list","items":["Dormimos peor.","Nos movemos menos.","Comemos rápido o poco nutritivo."]},{"type":"paragraph","text":"Esto aumenta la vulnerabilidad física y emocional. En psicología lo llamamos un bucle de vulnerabilidad: cuanto peor te sientes, menos haces lo que te cuida, y cuanto menos te cuidas, peor te sientes. \n\nVolver a hábitos que nos cuidan no solo aporta estructura y previsibilidad: le devuelve a tu cuerpo y a tu mente la sensación de seguridad, y eso es la base para tomar mejores decisiones y recuperar energía."}]},{"type":"collapsible","title":"La fuerza de los pequeños pasos","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio5sesion2ruta12.mp3","content":[{"type":"paragraph","text":"La Terapia Cognitivo-Conductual y la psicología del hábito coinciden: no necesitas un cambio radical para notar mejoras."},{"type":"list","items":["Moverte 10 minutos al día.","Preparar un desayuno nutritivo.","Reservar un rato para algo que disfrutas."]},{"type":"paragraph","text":"Estos gestos, aunque parezcan mínimos, generan una sensación de logro que alimenta tu motivación. En palabras de BJ Fogg, experto en hábitos, “el cambio se crea sintiéndote bien con lo que haces, no castigándote por lo que no haces”."}]},{"type":"collapsible","title":"Rutina rígida vs. ritual de cuidado","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio6sesion2ruta12.mp3","content":[{"type":"paragraph","text":"No todas las rutinas son iguales: algunas se vuelven rígidas y limitantes, mientras que otras actúan como un refugio flexible que te recarga.   • Rutina rígida disfuncional → Inflexible, vivida como obligación, genera ansiedad ante cambios.  Ejemplo: “Tengo que correr 5 km todos los días o no vale la pena”.   • Ritual de cuidado → Intencional, flexible y enfocado en tu bienestar, adaptable a tus circunstancias.  Ejemplo: “Hoy no puedo correr, pero haré 15 minutos de estiramientos en casa”.   Un ritual de cuidado no depende de que todo vaya bien para existir. Según la neurociencia del hábito, la flexibilidad y la asociación con emociones positivas aumentan la probabilidad de mantenerlo en el tiempo."}]},{"type":"collapsible","title":"Ideas para tus rituales de cuidado","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio7sesion2ruta12.mp3","content":[{"type":"paragraph","text":"Aquí tienes inspiración para crear los tuyos:   Autorreforzarte: darte pequeños premios o autoelogios sinceros cuando cumples tu objetivo.   Priorizar el placer diario: dar espacio a lo que te gusta sin sentir culpa.   Actividades agradables y de dominio: que te den sensación de logro y satisfacción (cocinar algo nuevo, aprender una habilidad).   Mindfulness y flexibilidad emocional: aceptar emociones y sensaciones sin juicio, dejando que pasen por sí solas.   Recuerda que el objetivo no es “tachar tareas”, sino crear experiencias que nutran tu cuerpo, tu mente y tu ánimo."}]},{"type":"collapsible","title":"Tu misión esta semana","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio8sesion2ruta12.mp3","content":[{"type":"paragraph","text":"Identifica y recupera al menos una rutina que te nutra. Hazlo pequeño, realista y disfrutable.  No se trata solo de “hacer cosas sanas”: se trata de reconectar con lo que de verdad te hace sentir bien y mantenerlo incluso en días difíciles.   En las próximas técnicas aprenderás a elegirla, adaptarla y mantenerla como una aliada para tu bienestar, pase lo que pase."}]},{"type":"title","text":"Técnicas Específicas"},{"type":"dailyWellbeingPlanExercise","title":"EJERCICIO 1: MI PLAN DIARIO DE BIENESTAR: 3 MICROHÁBITOS CLAVE","objective":"Este ejercicio te ayudará a elegir un microhábito físico, uno emocional y uno mental que puedas mantener incluso en días ocupados o difíciles, para que actúen como anclas que sostengan tu bienestar.","duration":"6-8 min","audioUrl":"https://workwellfut.com/audios/ruta12/tecnicas/Ruta12semana2tecnica1.mp3"},{"type":"morningRitualExercise","title":"EJERCICIO 2: MI RITUAL DE INICIO: UNA MAÑANA AMABLE E CONSCIENTE","objective":"Tus primeras acciones al despertar marcan el tono de todo lo que viene después. En este ejercicio vas a diseñar una rutina inicial breve que te permita aterrizar en tu día con presencia y equilibrio.","duration":"8-10 min","audioUrl":"https://workwellfut.com/audios/ruta12/tecnicas/Ruta12semana2tecnica2.mp3"},{"type":"therapeuticNotebookReflection","title":"Reflexión Final de la Semana","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Reflexionsesion2ruta12.mp3","prompts":["<p>En tu experiencia pasada, ¿qué papel crees que han jugado los hábitos en tu bienestar físico, emocional y mental?</p><ul><li>¿Cuando tus hábitos se debilitan o desaparecen, cómo sueles reaccionar y qué podrías hacer para asumir un papel más activo en recuperarlos?</li><li>¿Qué microhábitos o rituales has puesto en marcha y cómo te han hecho sentir?</li><li>¿Cómo cambia tu ánimo y tu energía cuando cuidas lo básico de tu cuerpo, tus emociones y tu mente?</li></ul>"]},{"type":"title","text":"Resumen Clave"},{"type":"paragraphWithAudio","text":"","audioUrl":"https://workwellfut.com/audios/ruta12/descripciones/sesion2/Resumensesion2ruta12.mp3"},{"type":"list","items":["Tus rutinas son anclas emocionales que estabilizan tu día y te ayudan a pensar con más claridad.","Cuidar lo básico (descanso, alimentación, movimiento) reduce la activación del sistema de alarma y mejora tu regulación emocional.","Los microhábitos pequeños y realistas tienen un efecto acumulativo enorme en tu bienestar y motivación.","La diferencia entre rutina rígida y ritual de cuidado está en la flexibilidad y la conexión con tu bienestar.","Un buen inicio de día (mañana amable) actúa como chispa que enciende tu energía y tu foco para el resto de la jornada."]},{"type":"quote","text":"El autocuidado no es un premio que te das cuando has sido productivo; es el punto de partida para poder serlo."}]}>
>      :      ^^^^^^
> 
> 
> Caused by:
