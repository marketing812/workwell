  ...
  modules: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'collapsible', title: 'Tu misión esta semana', audioUrl: 'https://workwellfut.com/audios/ruta12/descripciones/sesion2/Audio8sesion2ruta12.mp3', content: [{ type: 'paragraph', text: 'Identifica y recupera al menos una rutina que te nutra. Hazlo pequeño, realista y disfrutable.\nNo se trata solo de “hacer cosas sanas”: se trata de reconectar con lo que de verdad te hace sentir bien y mantenerlo incluso en días difíciles.\nEn las próximas técnicas aprenderás a elegirla, adaptarla y mantenerla como una aliada para tu bienestar, pase lo que pase.' }] },
        { type: 'title', text: 'Técnicas Específicas' },
