  ...
  modules: [
    {
      ...
      content: [
        ...
        {
          type: 'quote',
          text: 'Cada paso que das para cuidar tu energía es una inversión en tu bienestar. No importa si es grande o pequeño: lo importante es que sigues encendiendo tu propia luz.'
        }
      ]
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          content: [
            {
              type: 'paragraph',
              text: '¿Te ha pasado que, en momentos difíciles, lo primero que se desordena es lo que te sostiene?  Dormimos peor, comemos rápido, dejamos de movernos… y, sin darnos cuenta, el malestar crece.   Esta semana vamos a volver a lo esencial: recuperar esas rutinas que te alimentan por dentro y por fuera, que estabilizan tus días y te devuelven energía. No hablamos de forzarte a hacer todo perfecto, sino de crear pequeños anclajes que te ayuden a sentirte más estable y con más fuerza para afrontar lo que venga.'
            }
          ]
        },
        {
        ...
        },
        {
          ...
          content: [
            {
              type: 'paragraph',
              text: 'En momentos duros, solemos descuidar justo lo que más nos sostiene:'
            },
            {
              type: 'list',
            ...
            {
              type: 'paragraph',
              text: 'Esto aumenta la vulnerabilidad física y emocional. En psicología lo llamamos un bucle de vulnerabilidad: cuanto peor te sientes, menos haces lo que te cuida, y cuanto menos te cuidas, peor te sientes.'
            },
            {
              type: 'paragraph',
              text: 'Volver a hábitos que nos cuidan no solo aporta estructura y previsibilidad: le devuelve a tu cuerpo y a tu mente la sensación de seguridad, y eso es la base para tomar mejores decisiones y recuperar energía.'
            }
          ]
        },
        {
          ...
          content: [
            {
              type: 'paragraph',
              text: 'La Terapia Cognitivo-Conductual y la psicología del hábito coinciden: no necesitas un cambio radical para notar mejoras.'
            },
            {
              type: 'list',
              items: [
                'Moverte 10 minutos al día.',
                'Preparar un desayuno nutritivo.',
                'Reservar un rato para algo que disfrutas.'
              ]
            },
            {
              type: 'paragraph',
              text: 'Estos gestos, aunque parezcan mínimos, generan una sensación de logro que alimenta tu motivación. En palabras de BJ Fogg, experto en hábitos, “el cambio se crea sintiéndote bien con lo que haces, no castigándote por lo que no haces”.'
            }
          ]
        },
        {
        ...
        {
          type: 'quote',
          text: 'El cuidado de ti no depende de grandes gestos, sino de los pequeños actos que repites con intención, incluso en los días más difíciles.'
        }
      ]
    },
    {
      ...
      content: [
        ...
        {
          type: 'quote',
          text: '“Las ganas pueden tardar en llegar, pero si das el primer paso, siempre sabrán encontrarte.”'
        }
      ]
    },
    {
      ...
      content: [
        ...
        {
          type: 'quote',
          text: 'Cada recuerdo luminoso, cada gesto amable y cada momento positivo que eliges cultivar es como poner una moneda brillante en tu mochila interior. No evitará las tormentas, pero hará que siempre tengas con qué resguardarte'
        }
      ]
    },
    {
...
sigue fallando, arregla todos los archivos que estén mal formateados