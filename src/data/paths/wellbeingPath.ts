      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'paragraph', text: 'El bienestar sostenido, en cambio, es como encender una estufa que mantiene el calor mucho después: caminar, retomar un hobby, hablar con alguien que te importa.\nComo recuerda la Terapia Cognitivo-Conductual, las acciones que más levantan el ánimo suelen ser las que menos apetece hacer al principio.' }
          ]
        },
        {
          type: 'collapsible',
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'paragraph', text: 'Es como encender una luz tenue en una habitación oscura: al principio no ilumina todo, pero te permite moverte, encontrar otros interruptores y, poco a poco, llenar la habitación de claridad.' }
          ]
        },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'La Terapia Cognitivo-Conductual y la psicología del hábito coinciden: no necesitas un cambio radical para notar mejoras. Los pequeños pasos tienen un efecto acumulativo enorme:' },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'En pocas palabras, la motivación es ese empujón interno que nos mueve a hacer cosas que nos acercan a lo que nos hace bien y nos alejan de lo que nos perjudica.   Puede nacer de:' },
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'paragraph', text: 'Este cambio no es solo de palabras: también modifica cómo el cerebro procesa la tarea, activando zonas relacionadas con el sentido y la recompensa.   Y para que este cambio no se quede en palabras bonitas, vamos a conectar cada acción con algo más profundo: su valor y su sentido.' }
          ]
        },
        {
          type: 'collapsible',
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'paragraph', text: 'Importante: al principio, cultivar emociones positivas no siempre se siente natural. Puede que parezca forzado o que no tengas ganas, y eso es completamente normal. \n\nCon práctica y repetición, los circuitos cerebrales de motivación y recompensa se reactivan.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            ...
            { type: 'paragraph', text: 'Amplían la perspectiva: te permiten ver más ángulos de la misma situación, no quedarte solo en la parte dolorosa o negativa. Esto facilita la creatividad, el pensamiento flexible y la capacidad de encontrar soluciones que antes no veías. \n\nEjemplo: en un día difícil, recordar que alguien te apoyó en el pasado puede abrir la idea de pedir ayuda ahora.' },
            { type: 'paragraph', text: 'Equilibran la balanza emocional: ayudan a contrarrestar la carga de las emociones negativas y reducen el riesgo de quedarte atrapado o atrapada en bucles de preocupación, culpa o miedo. No se trata de eliminar lo difícil, sino de equilibrarlo para que no ocupe todo el espacio mental.' },
            { type: 'paragraph', text: 'Sostienen en el tiempo: fortalecen tu resiliencia, es decir, tu capacidad de adaptarte y recuperarte después de un golpe emocional. También mejoran la tolerancia al malestar: aprendes a convivir con las emociones desagradables sin que te bloqueen.' },
