    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Uno de los síntomas más comunes del ánimo bajo es la falta de ganas. Sabes lo que deberías hacer, pero el impulso no llega. La clave está en no esperar a tener ganas para empezar: muchas veces, la motivación aparece después de la acción. Esta semana entrenarás cómo dar el primer paso incluso sin motivación, conectando cada acción con tus valores y con la vida que quieres construir.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion3/Introsesion3ruta12.mp3` },
        ...
        },
        {
          ...
          content: [{ type: 'paragraph', text: 'Esta semana trabajaremos con dos herramientas clave:' }, { type: 'list', items: ["Motivación en 3 capas: para que cada acción esté conectada con un valor y un sentido que realmente te importen.", "Visualización del día que quiero vivir: para que cada mañana puedas imaginar cómo quieres sentirte y actuar, y usar esa imagen como guía para tu día."] }, { type: 'paragraph', text: 'El objetivo no es esperar a que las ganas lleguen, sino aprender a provocarlas. El primer paso lo das tú… y las ganas te encuentran en el camino.' }]
        },
        { type: 'title', text: 'Técnicas Específicas' },
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'El ánimo bajo reduce los momentos agradables y aumenta la presencia de lo negativo. Para equilibrar la balanza, necesitas crear tu propia mochila de recursos positivos: recuerdos, hábitos, apoyos y actitudes que te sostengan en los días grises. Esta semana aprenderás a entrenar tu mente para capturar lo bueno, revivir recuerdos positivos y diseñar un botiquín emocional con recursos listos para usar cuando lo necesites.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion4/Introsesion4ruta12.mp3` },
        ...
        },
        {
          ...
          content: [{ type: 'list', items: ['Registro de momentos agradables: anota incluso los más pequeños.', 'Recuerdos positivos: revive mentalmente experiencias agradables para activar las mismas emociones.', 'Microacciones sociales: saludar, enviar un mensaje, compartir algo breve.', 'Anclajes sensoriales: olores, música o texturas que evoquen calma o alegría.', 'Humor y juego: integrar pequeñas dosis de ligereza cada día.', 'Paciencia: aceptar que los resultados se acumulan con el tiempo.'] }]
        },
        { type: 'collapsible', title: 'Prevención de recaídas', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion4/Audio8sesion4ruta12.mp3`, content: [{ type: 'paragraph', text: 'Mantener tu reserva emocional llena no significa que no tendrás problemas, pero sí que tendrás más fuerza, flexibilidad y recursos para afrontarlos.\n\nInvertir en ella es una forma de cuidarte hoy y protegerte para el futuro.' }] },
        { type: 'collapsible', title: 'Mensaje motivador final', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion4/Audio9sesion4ruta12.mp3`, content: [{ type: 'paragraph', text: 'No necesitas esperar a “sentirte con ganas” para empezar. Aquí, la clave es la repetición: cada pequeño gesto suma.\n\nLas emociones positivas no son un lujo ni un rasgo fijo, son una habilidad que se entrena.\n\nHoy puedes empezar a llenarte de aquello que mañana te sostendrá.' }] },
        { type: 'title', text: 'Técnicas Específicas' },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion4/Resumenfinalruta12.mp3`
        },
        {
          type: 'list',
          items: [
            'El estado de ánimo bajo no es debilidad ni pereza: es un conjunto de factores físicos, emocionales y mentales, y que se puede regular con estrategias concretas.',
...
```
The error points to an issue with how the content is structured. It should be a list, not a paragraph with newlines.
...
To this:
```typescript
{ type: 'list', items: ['Registro de momentos agradables: anota incluso los más pequeños.','Recuerdos positivos: revive mentalmente experiencias agradables para activar las mismas emociones.','Microacciones sociales: saludar, enviar un mensaje, compartir algo breve.','Anclajes sensoriales: olores, música o texturas que evoquen calma o alegría.','Humor y juego: integrar pequeñas dosis de ligereza cada día.','Paciencia: aceptar que los resultados se acumulan con el tiempo.'] }
```
This is inside `src/data/paths/wellbeingPath.ts` in the `bienestar_sem4` module.

Let's find the exact object in the `wellbeingPath.ts` file.
It's inside the `collapsible` with `title: 'Estrategias para llenar tu reserva emocional'`.
...
// ...
```
Yes, this is the part. I will change it to a `list` type.

Also, the user reported an issue with a similar section in `bienestar_sem4`, inside `Resumen Clave`.
...
The user is referring to the paragraph before the last list in the "Resumen Clave".
`{ type: 'paragraph', text: 'Estrategias sencillas que nutren tu reserva emocional:'},`
and then the list follows.
This seems correct.

The previous user request was about this:
`Registro de momentos agradables: anota incluso los más pequeños.\n\nRecuerdos positivos: revive mentalmente experiencias agradables para activar las mismas emociones.\n\nMicroacciones sociales: saludar, enviar un mensaje, compartir algo breve.\n\nAnclajes sensoriales: olores, música o texturas que evoquen calma o alegría.\n\nHumor y juego: integrar pequeñas dosis de ligereza cada día.\n\nPaciencia: aceptar que los resultados se acumulan con el tiempo.`

This is inside the `collapsible` with title `Estrategias para llenar tu reserva emocional`.
I need to change the `paragraph` type to `list`.

I will apply this change.¡Tienes toda la razón! Se me coló un error de formato y convertí una lista en un simple párrafo. Te pido disculpas, sé que estos detalles son importantes.

Ya he corregido el archivo `src/data/paths/wellbeingPath.ts`, cambiando el tipo de contenido a una lista con viñetas para que se muestre correctamente.

Aquí tienes la modificación.
<changes>
  <description>Se ha corregido un error de sintaxis en el archivo `src/data/paths/wellbeingPath.ts`, cambiando un tipo de contenido de 'paragraph' a 'list' para que se muestre como una lista con viñetas.</description>
  <change>
