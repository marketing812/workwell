  ...
  modules: [
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Cuando estamos bajos de ánimo, lo primero que suele romperse es lo más básico: dormir bien, comer con calma, mover el cuerpo. Esto aumenta el malestar y nos deja más vulnerables. Esta semana aprenderás a reinstalar pequeños rituales de cuidado —microhábitos físicos, emocionales y mentales— que actúan como anclas en tu día. No se trata de hacer todo perfecto, sino de tener gestos breves, amables y repetidos que te devuelvan estabilidad y energía.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion2/Introsesion2ruta12.mp3` },
        ...
        { type: 'collapsible', title: 'Tu misión esta semana', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion2/Audio8sesion2ruta12.mp3`, content: [{ type: 'paragraph', text: 'Identifica y recupera al menos una rutina que te nutra. Hazlo pequeño, realista y disfrutable.' },  { type: 'paragraph', text: 'No se trata solo de “hacer cosas sanas”: se trata de reconectar con lo que de verdad te hace sentir bien y mantenerlo incluso en días difíciles. ' },{ type: 'paragraph', text: 'En las próximas técnicas aprenderás a elegirla, adaptarla y mantenerla como una aliada para tu bienestar, pase lo que pase.' }] },
        { type: 'title', text: 'Técnicas Específicas' },
        { type: 'dailyWellbeingPlanExercise', title: 'EJERCICIO 1: MI PLAN DIARIO DE BIENESTAR: 3 MICROHÁBITOS CLAVE', objective: 'Hay días en los que sentimos que el tiempo se nos escapa y que nuestras rutinas se desordenan.<br>La buena noticia es que no necesitas cambios drásticos para recuperar la sensación de control: basta con anclar tu día a tres gestos pequeños, pero estratégicos, que sostengan tu cuerpo, tus emociones y tu mente. Este ejercicio es tu “plan maestro de autocuidado”: vas a elegir un microhábito físico, uno emocional y uno mental que puedas mantener incluso en días ocupados o difíciles. Estos serán tus anclas: puntos fijos que mantendrán tu bienestar estable sin importar lo que pase fuera.', duration: '6-8 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/tecnicas/Ruta12semana2tecnica1.mp3` },
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'paragraph',
              text: 'Ejemplo práctico: Si tu energía es muy baja, en lugar de “hacer ejercicio 30 min”, proponte “poner música y mover el cuerpo 3 min” o “caminar hasta la esquina y volver”. Lo pequeño y repetido es lo que activa el cambio.',
            },
          ],
        },
        {
          ...
          content: [
            ...
            {
              type: 'paragraph',
              text: 'Idea para llevarte: piensa en las emociones positivas como en regar una planta: no basta con un gran riego un día, necesita pequeñas dosis constantes para crecer y mantenerse fuerte.',
            },
          ],
        },
        {
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        {
          ...
          objective: '¿Has notado que tu mente tiende a dar más vueltas a lo que salió mal que a lo que fue bonito o satisfactorio? Esto no es casualidad: el cerebro humano tiene un “sesgo negativo”, una especie de radar evolutivo que nos hace recordar más fácilmente lo doloroso que lo agradable. Sirvió para sobrevivir en el pasado (evitar peligros), pero hoy puede hacer que las cosas buenas pasen casi desapercibidas.',
          duration: '10-12 min',
        ...
        },
        {
          ...
          objective: 'Ya sabemos que nuestra mente guarda con más facilidad lo negativo que lo positivo.  ',
          duration: '12-15 min',
        ...
        { type: 'title', text: 'Resumen Clave' },
        {
          type: 'paragraphWithAudio',
          text: '',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta12/descripciones/sesion4/Resumenruta12.mp3`,
        },
        {
          type: 'list',
          items: [
            ...
            'Las emociones positivas no son un lujo, cumplen funciones esenciales para tu salud mental y tu bienestar.<div class="prose dark:prose-invert max-w-none pt-2 text-base"><ul><li>Amplían la mirada, ayudándote a ver soluciones y a pensar con más flexibilidad.</li><li>Equilibran el peso de lo negativo, evitando que todo se vea más oscuro de lo que es.</li><li>Sostienen tu resiliencia, dándote energía para seguir en días difíciles.',
            ...
            'Estrategias sencillas que nutren tu reserva emocional:<div class="prose dark:prose-invert max-w-none pt-2 text-base"><ul ><li>Recordar momentos agradables y revivirlos con detalle.</li><li>Realizar microacciones sociales (mandar un mensaje, tomar un café)</li><li>Usar música, humor y gestos como la sonrisa.</li><li>Cuidar hábitos básicos: descanso, movimiento, alimentación y contacto con la naturaleza.</li></ul></div>',
          ],
        },
        {
          type: 'quote',
          text:
            'Cada experiencia positiva que incorporas es una reserva interna. No impide las crisis, pero te da margen para sostenerte mejor en ellas.',
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'quote',
          text:
            'Volver a lo que te hace sentir bien no es regresar al pasado, sino construir, paso a paso, un presente más habitable. Cada gesto, cada recuerdo y cada elección consciente son semillas de bienestar que seguirán creciendo dentro de ti.',
        },
      ],
    },
  ],
