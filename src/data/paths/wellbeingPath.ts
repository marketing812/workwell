  ...
  modules: [
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Uno de los síntomas más comunes del ánimo bajo es la falta de ganas. Sabes lo que deberías hacer, pero el impulso no llega. La clave está en no esperar a tener ganas para empezar: muchas veces, la motivación aparece después de la acción. Esta semana entrenarás cómo dar el primer paso incluso sin motivación, conectando cada acción con tus valores y con la vida que quieres construir.', audioUrl: 'https://workwellfut.com/audios/ruta12/descripciones/sesion3/Introsesion3ruta12.mp3' },
        ...
        { type: 'collapsible', title: 'Lo que vamos a entrenar esta semana', audioUrl: 'https://workwellfut.com/audios/ruta12/descripciones/sesion3/Audio8sesion3ruta12.mp3', content: [{ type: 'paragraph', text: 'Esta semana trabajaremos con dos herramientas clave:' }, { type: 'list', items: ["Motivación en 3 capas: para que cada acción esté conectada con un valor y un sentido que realmente te importen.", "Visualización del día que quiero vivir: para que cada mañana puedas imaginar cómo quieres sentirte y actuar, y usar esa imagen como guía para tu día."] }, { type: 'paragraph', text: 'El objetivo no es esperar a que las ganas lleguen, sino aprender a provocarlas. El primer paso lo das tú… y las ganas te encuentran en el camino.' }] },
        { type: 'title', text: 'Técnicas Específicas' },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          audioUrl: 'https://workwellfut.fut/audios/ruta12/descripciones/sesion4/Audio7sesion4ruta12.mp3',
        ...
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: 'https://workwellfut.com/audios/ruta12/descripciones/sesion4/Reflexionssesion4ruta12.mp3', prompts: ["Esta semana has explorado el poder de cultivar emociones positivas como una forma de cuidar tu bienestar a largo plazo.", "¿Qué descubriste esta semana sobre tu capacidad para reconocer y generar emociones positivas?", " ¿Qué quieres ajustar en tu día a día para que tu capacidad de generar emociones positivas funcione mejor?", "¿Qué cosas, personas o experiencias forman parte de tu propia “mochila de reserva”?", "¿Qué hábitos sencillos (ej. dormir bien, caminar, escuchar música) notas que te ayudan a mantenerte más sereno/a y equilibrado/a?", "Cuando reviviste un recuerdo positivo o usaste uno de tus recursos, ¿qué cambió en tu estado de ánimo?", "¿Qué tres pequeñas acciones concretas podrías repetir la próxima semana para seguir fortaleciendo tu reserva emocional?"] },
        { type: 'title', text: 'Resumen Clave' },
