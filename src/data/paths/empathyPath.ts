      ...
      content: [
        {
          ...
          text: '¿Te ha pasado que dices que "sí" aunque querías decir "no"?¿O que sales de una conversación con una sensación de incomodidad por no haber expresado algo importante?Esta semana vamos a explorar el verdadero significado de los límites: no como un muro que separa, sino como un puente que te conecta contigo y con los demás desde el respeto. Aprenderás por qué nos cuesta tanto ponerlos, qué emociones aparecen y cuáles son tus patrones más comunes cuando no logras expresarte.Verás que poner un límite no es rechazar a nadie: es incluirte también a ti en la relación.Cada vez que te eliges con respeto, estás entrenando tu autoestima.',
    ...
    },
    {
      ...
      content: [
        ...
        { 
          ...
          content: [{ type: 'paragraph', text: 'La fusión emocional ocurre cuando el dolor del otro te inunda por completo. \n\nDejas de escuchar tus propias emociones y actúas desde la culpa, la urgencia o el miedo.' }] 
        },
        { 
          type: 'collapsible', 
          ...
          content: [{ type: 'paragraph', text: 'Resonancia afectiva: es una reacción emocional automática e instintiva ante lo que siente otra persona. El cuerpo responde sin reflexión ni distancia. \n\nEmpatía: es la capacidad consciente y regulada de comprender y acompañar la emoción del otro, sin perderse en ella. \n\nFusión emocional: es la pérdida de límites emocionales donde se carga con lo que no corresponde, confundiendo cuidar con hacerse responsable del malestar ajeno.' }] 
        },
        { 
          type: 'collapsible', 
