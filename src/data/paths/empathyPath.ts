  ...
  modules: [
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            { type: 'list', items: [
                ...
                'Escuchar cómo te sientes antes de actuar o responder.',
                'Expresarte con más verdad y con más respeto, hacia ti y hacia el otro.',
            ]},
            { type: 'paragraph', text: 'Porque ser auténtico o auténtica no es imponer tu verdad…\nEs no dejarte fuera de lo que estás viviendo.'}
          ]
        },
        {
          type: 'collapsible',
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        {
          ...
          objective: '¿Alguna vez has sentido que en ciertas relaciones estás actuando, en lugar de ser tú? Este ejercicio te ayuda a observar con honestidad y sin juicio cómo te muestras en tus vínculos cotidianos. Vas a descubrir en qué relaciones puedes ser tú con libertad… y en cuáles tiendes a ponerte una máscara para protegerte o agradar. No se trata de cambiar todo de golpe, sino de empezar a reconocer tu verdad y recuperar tu presencia en cada vínculo.',
          duration: '15-20 min',
        ...
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: 'https://workwellfut.com/audios/ruta5/descripciones/semana1/REFLEXION.mp3', prompts: [
            ...
            '¿Cómo se resienten mis relaciones cuando no soy empático/a con los demás? ¿Y conmigo?',
            '¿Qué beneficios emocionales empiezo a notar cuando me expreso con más verdad, incluso en pequeños gestos?',
        ...
        { type: 'list', items: [
            ...
            'Las frases bienintencionadas que minimizan el malestar generan invalidación emocional.',
            'La autenticidad florece cuando hay espacio seguro creado por la empatía.',
            'Ser honesto/a emocionalmente no es decirlo todo sin filtro, sino aprender a expresar lo esencial con respeto.',
            'Las máscaras relacionales protegen, pero también desconectan de uno/a mismo/a y de los demás.',
            'Esta semana entrenas a detectar tus máscaras, escuchar tus emociones y expresarte desde tu verdad.',
    ...
    },
    {
      ...
      content: [{ type: 'paragraph', text: '¿Te ha pasado alguna vez que alguien te escuchaba, pero sentías que no estaba realmente contigo?\nQuizás te miraba, pero su mente estaba en otro sitio, o te respondía tan rápido que parecía tener la solución antes de que acabaras de hablar.\nEsta semana vamos a entrenar una forma de escucha profunda y sin juicio, en la que puedas acompañar emocionalmente a otra persona sin interrumpir, sin aconsejar y sin hablar de ti. Aprenderás a reflejar lo que el otro siente, creando un espacio de validación auténtica.' },{ type: 'title', text: 'Psicoeducación' },{ type: 'collapsible', title: '¿Escuchas para responder o para comprender?', content: [{ type: 'paragraph', text: 'A menudo, oímos sin escuchar profundamente. Escuchamos para corregir, para dar consejos, para aliviar el malestar… pero muy pocas veces escuchamos para comprender de verdad. La escucha empática es una presencia distinta: no exige, no interrumpe, no intenta arreglar. Solo está.' }] },{ type: 'collapsible', title: '¿Qué bloquea nuestra escucha empática?', content: [{ type: 'paragraph', text: 'Incluso cuando queremos ayudar, hay reacciones automáticas que interrumpen la conexión emocional:' }, { type: 'list', items: ['Intentar calmar demasiado rápido (“No te pongas así”).', 'Ofrecer soluciones sin validar (“Lo que tienes que hacer es…”).', 'Minimizar o comparar (“A mí me pasó algo peor y aquí estoy”).', 'Estar físicamente presente pero emocionalmente ausente (mirar el móvil).', 'Anticipar y no dejar terminar (“Ya sé lo que vas a decir”).'] }, { type: 'paragraph', text: 'Estas actitudes, aunque habituales, hacen que el otro se sienta solo o incomprendido.'}] },{ type: 'collapsible', title: 'Validar no es justificar. Es comprender.', content: [{ type: 'paragraph', text: 'Validar emocionalmente no significa que estés de acuerdo con todo. Significa decir (con palabras o sin ellas): “Entiendo que lo que sientes tiene sentido desde tu vivencia”. En vez de “No deberías sentirte así”, puedes decir “Puedo ver que esto te está afectando mucho”. Validar es sostener la emoción del otro sin juzgarla ni querer cambiarla.' }] },{ type: 'collapsible', title: '¿Por qué nos cuesta tanto escuchar así?', content: [{ type: 'paragraph', text: 'Porque no nos lo enseñaron. Aprendimos a resolver, a tranquilizar, a corregir… pero no a quedarnos presentes mientras el otro siente algo incómodo. Escuchar de verdad implica estar ahí, aunque no sepamos qué decir. Y para poder hacerlo con el otro, necesitas practicarlo primero contigo.' }] },{ type: 'title', text: 'Técnicas Específicas' },{ type: 'empathicMirrorExercise', title: 'EJERCICIO 1: EL ESPEJO EMPÁTICO', objective: 'Este ejercicio te invita a entrenar una forma de escucha profunda y sin juicio, en la que puedas acompañar emocionalmente a otra persona sin interrumpir, sin aconsejar y sin hablar de ti. Aprenderás a reflejar lo que el otro siente, creando un espacio de validación auténtica.', duration: '10-12 min' },{ type: 'validationIn3StepsExercise', title: 'EJERCICIO 2: VALIDACIÓN EN 3 PASOS', objective: 'Este ejercicio te muestra una forma sencilla y poderosa de estar presente con el otro sin intentar arreglar nada. Aprenderás a validar emocionalmente en tres pasos muy concretos, para que la otra persona sienta que su experiencia tiene sentido y que no está sola.', duration: '10 min' },{ type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', prompts: ['¿Cuándo fue la última vez que alguien me escuchó de verdad, sin juicio ni prisa?','¿Qué hizo esa persona para que yo me sintiera tan visto/a y comprendido/a?','¿Qué impacto emocional tiene en mis vínculos cuando interrumpo, comparo o minimizo lo que el otro siente?','¿Qué me gustaría empezar a ofrecer más en mis relaciones: más silencio, más validación, más presencia...?','¿Qué me llevo esta semana como recordatorio para ser mejor compañía, para los demás y para mí?'] },{ type: 'title', text: 'Resumen Clave' },{ type: 'list', items: ['Escuchar de verdad no es lo mismo que oír: requiere presencia, pausa y conexión emocional.','La mayoría de las veces, respondemos para corregir o tranquilizar, no para comprender.','Frases como “No es para tanto” o “Mira el lado bueno” pueden invalidar profundamente al otro.','Validar no significa justificar. Es decir: “Lo que sientes tiene sentido desde tu vivencia.”','La empatía empieza en el silencio y se cultiva en la atención y la práctica.'] },{ type: 'quote', text: 'Escuchar de verdad es una forma profunda de amar sin condiciones. A veces, basta con quedarte al lado del otro… sin apagar lo que siente.' }]
    },
    {
      id: 'empatia_sem3',
