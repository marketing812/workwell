  ...
  modules: [
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'list', items: ['La rama simpática pisa el acelerador (sube la frecuencia cardíaca, la respiración, la tensión muscular).','La rama parasimpática actúa como freno (calma, ayuda a la digestión y al descanso).']},
        ...
        },
      {
          type: 'collapsible',
          title: 'Final',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana1/Ruta13sem1frasedecierre.mp3`,
          content: [
            { type: 'paragraph', text: 'Con estos aprendizajes, ya tienes una base clara para empezar a mirar tu ansiedad de otra manera: no como un monstruo al que vencer, sino como un sistema de alarma que necesita reajustarse. '}
          ]
        },
        { type: 'title', text: 'Técnicas Específicas' },
        { 
            type: 'ansiedadTieneSentidoExercise',
            title: 'EJERCICIO 1: MI ANSIEDAD TIENE SENTIDO CUANDO…',
        ...
        },
        {
            ...
            title: 'EJERCICIO 2: VISUALIZACIÓN GUIADA DEL CUERPO EN ANSIEDAD',
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Cuando la ansiedad llega, parece que no hay botón de pausa. El cuerpo se acelera y la mente se llena de pensamientos catastróficos. Esta semana vas a descubrir que sí existe una forma de frenar: aprenderás técnicas sencillas para interrumpir la escalada, bajar la activación y recuperar el control. Como un piloto que activa el freno de emergencia para estabilizar el avión, tú también puedes activar tus recursos internos para volver a sentir seguridad.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana2/R13sem2introducc.mp3`},
        ...
        { 
            ...
            content: [
                ...
                { type: 'collapsible', title: 'Técnica 10: Contacto frío breve (reset inmediato)', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana2tecnica20contactofrio.mp3`, content: [{ type: 'paragraph', text: 'Cómo aplicarlo:'},{ type: 'list', items: ['Humedece una toalla o paño con agua fría.','Aplícalo entre 10 y 20 segundos en la nuca, las muñecas o la parte interna de los brazos o mejillas.','Respira mientras sientes el contacto del frío.']},{ type: 'paragraph', text: 'Si estás fuera de casa, puedes usar agua del grifo o un cubito envuelto en tela.\nEste pequeño “shock” activa una respuesta calmante en tu cuerpo y te ayuda a pausar el bucle de ansiedad.'}]},
                { type: 'collapsible',  audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana2tecnica21respiracion478.mp3`,title: 'Técnica 11: Respiración 4–7–8 (avanzada, para calma y sueño)', content: [{ type: 'paragraph', text: 'Cómo funciona: Inhalas 4 segundos, retienes 7 y exhalas 8. Esta retención larga, combinada con la exhalación prolongada, produce un efecto sedante.\n\nEfecto: Induce estados de calma profunda y favorece la conciliación del sueño. No es recomendable en plena hiperventilación, pero sí como práctica regular para entrenar la calma y preparar el cuerpo para dormir.'}]},
                { type: 'paragraph', text: 'Nota rápida: El orden prioriza lo que modula con más consistencia el SNA (Sistema Nervioso Autónomo) y mantiene el efecto (coherencia, diafragmática, exhalación y RMP -Relajación Muscular Progresiva) frente a recursos útiles, pero más situacionales o breves (anclaje, frío, presión profunda, 4–7–8).  Tu experiencia y preferencia personal también cuentan: si una técnica “te engancha”, su eficacia real sube porque la practicarás más. '},
        ...
        { 
          ...
          prompts: [
            '<p>Esta semana has practicado un principio muy poderoso: si calmas tu cuerpo, tu mente encuentra descanso. <br>Has aprendido que la ansiedad no solo vive en tus pensamientos, también en tus músculos, en tu respiración y en tu corazón. Y que, al entrenar técnicas como la respiración, la relajación o el anclaje sensorial, puedes recuperar el mando poco a poco. </p><p>Ahora te invito a detenerte un momento y escribir: </p><ul><li>¿Qué técnica me ha resultado más útil o fácil de practicar esta semana? </li><li>¿Qué cambios he notado en mi cuerpo y en mi mente después de entrenarla? </li><li>¿Qué situación concreta podría empezar a afrontar aplicando una de estas herramientas antes o durante el momento de ansiedad?</li></ul><p>Recuerda: no se trata de hacerlo perfecto, sino de repetir y descubrir que cada práctica es un paso para reeducar a tu sistema nervioso. </p>'
          ]
        },
        { type: 'title', text: 'Resumen Clave'},
    ...
    },
    {
      ...
      estimatedTime: '20-25 min',
      content: [
        { type: 'paragraphWithAudio', text: 'La ansiedad suele engañarnos con un truco: confunde lo posible con lo probable. “¿Y si…?” se convierte en un túnel sin salida. Esta semana aprenderás a dar un paso atrás, a mirar tus pensamientos sin creerlos al 100% y a abrir la puerta a alternativas más realistas. Se trata de entrenar tu mente para no quedar atrapada en el catastrofismo y encontrar nuevas formas de interpretar lo que pasa. Como un explorador curioso, vas a observar tu mundo interno con más distancia y menos juicio.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/R13sen3introduccion.mp3`},
        { type: 'title', text: 'Psicoeducación' },
        { type: 'collapsible', title: 'El invitado pesado de tu mente: los pensamientos anticipatorios', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/R13sem3pant1invitadopesado.mp3`, content: [{ type: 'paragraph', text: 'Cuando la ansiedad aparece, tu mente suele adelantarse al futuro con preguntas como:' }, { type: 'list', items: ['¿Y si me da un ataque en medio del trabajo?', '¿Y si pierdo el control delante de todos?', '¿Y si me pasa algo malo?'] }, { type: 'paragraph', text: 'Estos se llaman pensamientos anticipatorios: no hablan de lo que ocurre ahora, sino de lo que podría pasar mañana o dentro de unos minutos. Son como un “adelanto de cine” donde tu cerebro solo te enseña las escenas de terror.\n\nLa neurociencia ha demostrado que el cerebro humano está diseñado para anticipar, porque así aumenta las posibilidades de supervivencia (LeDoux, 2015). El problema es que, en la ansiedad, ese mecanismo se dispara y todo se percibe como amenaza.' }] },
        {
          type: 'collapsible',
        ...
        { type: 'collapsible', title: 'El bucle mental: dar vueltas y vueltas sin llegar a ninguna parte', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt3BucleMental.mp3`, content: [{ type: 'paragraph', text: 'Y luego están los bucles de pensamiento. Empiezan como una pequeña idea (“¿y si…?”), pero cuanto más giras sobre ella, más grande se hace.\n\nEs como una bola de nieve que rueda cuesta abajo: empieza pequeña, pero con cada vuelta arrastra más y más hasta que parece enorme e imparable. O como un disco rayado que repite la misma frase una y otra vez sin dejarte avanzar.\n\nLa neurociencia del pensamiento rumiativo muestra que, en esos momentos, la red neuronal por defecto (Default Mode Network) se activa de forma excesiva, alimentando la repetición de pensamientos en lugar de la resolución de problemas.' }] },
        { type: 'collapsible', title: 'El secuestro emocional: cuando manda la amígdala', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt4SecuestroEmocional.mp3`, content: [{ type: 'paragraph', text: 'En un pico de ansiedad, ocurre lo que Daniel Goleman (1995) llamó el “secuestro emocional”: la amígdala, ese detector de humo interno, se enciende con tanta fuerza que casi apaga tu corteza prefrontal (la parte racional del cerebro).\n\nResultado: piensas en bucle, sientes que te bloqueas y cuesta recordar incluso lo más sencillo. Es como si la alarma de incendios estuviera tan alta que no escuchas ninguna otra voz.' }] },
        { type: 'collapsible', title: 'No se trata de luchar, sino de observar', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt5NoLuchar.mp3`, content: [{ type: 'paragraph', text: 'Aquí está la clave: no se trata de controlar ni eliminar lo que piensas. Eso sería como intentar parar las olas del mar con las manos. \n\nLo que sí puedes aprender es a observar lo que aparece en tu mente sin dejarte arrastrar automáticamente por ello. \n\nEsto es lo que en Terapia de Aceptación y Compromiso se llama defusión cognitiva (Hayes, 2011): relacionarte con tus pensamientos de una forma más flexible, sin dar por cierto todo lo que aparece en tu mente ni actuar automáticamente en función de ello.\n\nPor ejemplo, imagina que antes de una reunión aparece el pensamiento: “Voy a hacerlo fatal”. Si te fusionas con ese pensamiento, es fácil que te bloquees, te pongas más nervioso o incluso evites intervenir. En cambio, si lo observas con algo de distancia, puedes reconocer: “Estoy teniendo el pensamiento de que voy a hacerlo fatal”. El pensamiento sigue ahí, pero ya no manda sobre ti de la misma manera. Y desde ese lugar, puedes actuar con más calma y seguir adelante, aunque aparezca la duda. ' }] },
        { type: 'collapsible', title: 'Entrenar la mente como un músculo', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt6EntrenarMente.mp3`, content: [{ type: 'paragraph', text: 'Cada vez que practicas observar, cuestionar y soltar un pensamiento ansioso, estás entrenando tu cerebro como si hicieras ejercicio en un gimnasio.'},{ type: 'list', items: ['Al principio cuesta.','Después de repetirlo, se vuelve más natural.','Con el tiempo, tu “músculo mental” se fortalece y la ansiedad pierde poder sobre ti.']},{ type: 'paragraph', text: 'La neurociencia lo llama neuroplasticidad: tus circuitos cerebrales cambian con la práctica, igual que los músculos cambian con el entrenamiento.' }] },
        { type: 'collapsible', title: 'Preparándote para la práctica', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt7Preparandote.mp3`, content: [{ type: 'paragraph', text: 'Ahora que entiendes mejor cómo funcionan los pensamientos ansiosos (anticipatorios, catastrofistas, bucles) y cómo la amígdala puede secuestrar tu mente, pasamos a lo más importante: las técnicas que te ayudarán a no engancharte a esos pensamientos.\n\nRecuerda: no buscamos que dejen de aparecer, sino que aprendas a mirarlos de frente, sin miedo, hasta que dejen de arrastrarte.' }] },
      { type: 'collapsible', title: 'Resumen clave', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/semana3/Ruta13Sem3Pnt8Resumen.mp3`, content: [{ type: 'paragraph', text: '<div class="pt-2 text-base leading-relaxed [&amp;_ul]:list-disc [&amp;_ul]:list-inside [&amp;_ul]:space-y-2 [&amp;_ul]:mb-4 [&amp;_ul]:pl-4"><ul><li>Los pensamientos ansiosos suelen aparecer en tres formas: anticipatorios, catastrofistas o en bucle.</li><li>Tu cerebro los fabrica para protegerte, pero muchas veces exagera.</li><li>No necesitas luchar con ellos, sino observarlos y dejarlos pasar.</li><li>Con práctica, tu mente aprende a soltar y recuperar la calma</li></ul></div>' }] },

         { type: 'title', text: 'Técnicas Específicas' },
        { type: 'stopExercise', title: 'EJERCICIO 1: STOP - PONLE UN ALTO AL PILOTO AUTOMÁTICO', objective: 'Con esta técnica aprenderás un “botón de pausa mental” que interrumpe el bucle ansioso y te devuelve al presente en menos de un minuto.', duration: '2-3 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana3tecnica1.mp3` },
        {
        ...
        { type: 'quote', text: 'No tienes que apagar cada pensamiento ansioso; basta con aprender a no dejar que te arrastre.', align: 'left' }
      ]
    },
    {
      id: 'ansiedad_sem4',
      ...
      content: [
        ...
        { type: 'calmVisualizationExercise', title: 'EJERCICIO 2: ME VEO HACIÉNDOLO CON CALMA', objective: 'Usa tu imaginación como herramienta. Cuando visualizas que te enfrentas a una situación temida de forma calmada, entrenas a tu sistema nervioso para responder con menos alarma en la vida real. Esta práctica es como un ensayo mental que reduce la anticipación ansiosa y prepara tu cuerpo para exponerte en pasos pequeños. Tiempo estimado: 8-10 minutos. Te recomiendo hacerlo 3-4 veces por semana, ideal antes de cada exposición real.', duration: '8-10 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana4tecnica2.mp3` },
        {
          ...
          prompts: [
            ...
            '<li>¿Qué has comprobado en ti cuando has dado un pequeño paso, aunque fuera pequeño, en dirección a la exposición?</li>',
