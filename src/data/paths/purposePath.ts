...
export const purposePath: Path = {
  ...
  audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/INTRORUTA7.mp3`,
  modules: [
    {
      id: 'purpose_sem1',
      title: 'Semana 1: ¿Qué es lo Importante para Mí?',
      type: 'introduction',
      ...
      content: [
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/INTRODUCCIONSEMANA1.mp3`
        },
        { type: 'title', text: 'Psicoeducación' },
        {
          type: 'collapsible',
          title: 'Lo urgente no siempre es lo importante',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/LOURGENTENOSIEMPREESLOIMPORTANTE.mp3`,
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/ELPILOTOAUTOMATICOQUENOSALEJADELPROPOSITO.mp3`,
        ...
        {
          type: 'collapsible',
          title: 'Los valores: tu brújula vital',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/TUSVALORESLABRUJULAVITAL.mp3`,
          content: [{ type: 'paragraph', text: 'Los valores no son metas concretas, sino direcciones que orientan nuestra vida. Son como la estrella polar que siempre está ahí, incluso en noches oscuras.\n- Una meta es llegar a un punto: “Quiero comprar una casa”.\n- Un valor es la dirección continua: “Quiero crear un hogar cálido y seguro”.\nEn la Terapia de Aceptación y Compromiso (Hayes, 1999), se trabaja mucho con valores porque actuar en coherencia con ellos aumenta el bienestar profundo y duradero. \nLa neurociencia confirma que cuando actuamos desde nuestros valores, se activan circuitos cerebrales de recompensa más estables que los que se activan con logros pasajeros.\nEjemplo: Si tu valor es la honestidad, no controlas lo que otros piensen, pero sí puedes elegir hablar con sinceridad. Ese gesto, aunque sea incómodo, fortalece tu autoestima.' }]
        },
        {
          type: 'collapsible',
          title: '¿De dónde nacen mis valores?',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/DEDONDENACENMISVALORES.mp3`,
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/PARAQUESIRVENLOSVALORES.mp3`,
        ...
        { type: 'valuesCompassExercise', title: 'EJERCICIO 1: MI BRÚJULA DE VALORES', objective: 'Ayudarte a identificar las áreas de tu vida que son verdaderamente significativas para ti (como relaciones, salud, crecimiento personal o contribución), para que puedas empezar a tomar decisiones alineadas con tu dirección vital, no solo con lo urgente. Al hacerlo, fortaleces tu identidad, desarrollas claridad emocional y empiezas a construir una vida más coherente y plena.', duration: '10–15 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana1tecnica1.mp3` },
        { type: 'energySenseMapExercise', title: 'EJERCICIO 2: MAPA DE ENERGÍA VS. SENTIDO', objective: 'Ayudarte a tomar conciencia de cómo distribuyes tu energía diaria entre tareas que simplemente “te ocupan” y aquellas que realmente te conectan con tus valores. El objetivo es detectar desequilibrios y redirigir parte de tu energía hacia lo que te hace sentir viva, presente y en coherencia contigo misma.', duration: '10–12 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana1tecnica2.mp3` },
        {
          type: 'therapeuticNotebookReflection',
          title: 'Reflexión Final de la Semana',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/REFLEXION.mp3`,
          prompts: [
        ...
        { type: 'paragraphWithAudio', text: '', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana1/RESUMEN.mp3` },
    ...
    {
      id: 'purpose_sem2',
      title: 'Semana 2: Detecta lo que te Desvía',
      type: 'skill_practice',
      estimatedTime: '20-25 min',
      content: [{ type: 'paragraphWithAudio', text: 'Sabes lo que quieres… pero una niebla de “deberías”, comparaciones y miedos te saca de camino.\nEsta semana ponemos nombre a ese “ruido mental” (exigencia, distorsiones, evitación) que te empuja al “tengo que” y te aleja de lo valioso. Con un inventario claro y una visualización “yo presente vs. yo esencial”, vas a reconocer señales rojas, amarillas y verdes (tu semáforo mental) y volver a lo importante sin culpas.\nComo recuerda Goleman, identificar la activación emocional es el primer paso para regularla.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/INTRODUCCIONSEMANA2.mp3` },
        { type: 'title', text: 'Psicoeducación' },
        { type: 'collapsible', title: 'El ruido interno: esa niebla que confunde', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Elruidointernoesanieblaqueconfunde.mp3`, content: [{ type: 'paragraph', text: '¿Has sentido alguna vez que tienes claro lo que quieres, pero algo dentro te empuja en otra dirección? Esa fuerza se parece a una niebla mental: pensamientos repetitivos, miedos o exigencias que no dejan ver con claridad.\nNo significa que haya “algo mal” en ti; es simplemente la manera en que tu cerebro, diseñado para sobrevivir, trata de anticipar y protegerte. Como explica Daniel Goleman, nuestra mente tiende a estar “secuestrada” por la alarma emocional, aun cuando no hay un peligro real.\nEl reto no es eliminar ese ruido, sino reconocerlo para recuperar el timón de tus decisiones.' }] },
        { type: 'collapsible', title: 'Vivir en piloto automático', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Vivirenpilotoautomatico.mp3`, content: [{ type: 'paragraph', text: 'Muchas veces no decides tú, decide el “tengo que”. Entre obligaciones, expectativas externas y comparaciones, entramos en modo piloto automático.\nLa neurociencia muestra que en este estado predomina la amígdala (sistema de amenaza), reduciendo la actividad de la corteza prefrontal, que es la parte encargada de planear y elegir con calma.\nEl resultado: actuamos por inercia, no por elección. Nos desconectamos de lo que nos da sentido.\nSi alguna vez has cancelado un plan que te hacía ilusión por algo “más urgente”, ya sabes lo que es dejar que el piloto automático tome el control.' }] },
        { type: 'collapsible', title: 'El miedo a no estar a la altura', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Elmiedoanoestaralaaltura.mp3`, content: [{ type: 'paragraph', text: 'Otra gran fuente de ruido es el miedo al juicio y al fracaso. Pensamientos como:\n- “¿Y si me equivoco?”\n- “¿Y si me juzgan?”\n- “¿Y si descubren que no soy suficiente?”\nSteven Hayes, creador de la Terapia de Aceptación y Compromiso (ACT), explica que el problema no es sentir miedo, sino dejar que ese miedo decida por ti.\nQuerer cambiar de trabajo, pero quedarte en un lugar que no te nutre por temor al rechazo, es un ejemplo de cómo el miedo nos paraliza y nos aleja de lo que valoramos.' }] },
        { type: 'collapsible', title: 'Cuando tus pensamientos exageran la realidad', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Cuandotuspensamientosexageranlarealidad.mp3`, content: [{ type: 'paragraph', text: 'No todo lo que piensas refleja la realidad. La mente humana tiende a caer en distorsiones cognitivas: catastrofismo, pensamiento “todo o nada”, autoexigencia desmedida.\nEjemplo: cometes un error menor en el trabajo y piensas “Soy un desastre”. \nLa neurociencia ha comprobado que este tipo de pensamientos negativos se fijan más fácilmente en la memoria, porque el cerebro está entrenado para detectar peligros.\nEl problema no es tener estas distorsiones, sino creerlas sin cuestionarlas.' }] },
        { type: 'collapsible', title: 'Evitar lo que más te importa', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Evitarloquemasteimporta.mp3`, content: [{ type: 'paragraph', text: 'Paradójicamente, el ruido mental nos lleva a evitar justo lo que más valoramos.\n¿Por qué? Porque acercarnos a lo importante nos hace sentir vulnerables: podríamos fallar, decepcionar o exponernos al rechazo.\nEjemplo: deseas una relación cercana y auténtica, pero evitas expresar lo que sientes. Cada silencio te protege a corto plazo… y te aleja a largo plazo de la conexión que tanto anhelas.\nLa psicóloga Susan David señala que la evitación emocional es como tratar de tapar una olla a presión: al final el vapor encuentra la forma de salir, normalmente con más fuerza. Afrontar, aunque sea en pasos pequeños, libera esa presión y nos conecta con lo que realmente nos nutre.' }] },
        { type: 'collapsible', title: 'Volver a lo esencial', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/Volveraloesencial.mp3`, content: [{ type: 'paragraph', text: 'La buena noticia es que siempre puedes volver. No hace falta hacerlo perfecto, basta con detectar el desvío y dar un pequeño paso hacia lo que importa.\nVolver a lo esencial no significa añadir más cosas, sino soltar lo que sobra: creencias heredadas, exigencias imposibles, miedos que ya no sirven.\nEjemplo: detenerte un instante, respirar y elegir conscientemente contestar un correo después, para poder disfrutar de tu paseo o tu comida con calma.\nRecuerda: tu mente hará ruido, pero siempre tendrás la capacidad de elegir tu dirección.' }] },
        { type: 'title', text: 'Técnicas Específicas' },
        { type: 'detoursInventoryExercise', title: 'EJERCICIO 1: INVENTARIO DE DESVÍOS', objective: '¿Alguna vez has sentido que vives en “piloto automático”, como si te alejaras poco a poco de lo que realmente importa?\nEste ejercicio te ayuda a detectar los desvíos —hábitos, pensamientos, conductas o entornos— que te apartan de tus valores. Reconocerlos es el primer paso para volver a elegir con más libertad y coherencia.', duration: '15–20 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana2tecnica1.mp3` },
        { type: 'presentVsEssentialSelfExercise', title: 'EJERCICIO 2: VISUALIZACIÓN DEL YO PRESENTE VS. YO ESENCIAL', objective: 'Observar desde una posición compasiva cómo estás viviendo hoy y cómo te gustaría vivir si actuaras desde tus valores. Esta visualización te permite recuperar una imagen inspiradora de tu esencia.', duration: '10–15 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana2tecnica2.mp3` },
        { type: 'mentalNoiseTrafficLightExercise', title: 'MICROPRÁCTICA OPCIONAL: SEMÁFORO DEL RUIDO MENTAL', objective: 'Usa esas señales como un recordatorio para frenar, respirar y reconectar contigo.', duration: '5–7 min' },
        { 
          type: 'therapeuticNotebookReflection', 
          title: 'Reflexión Final de la Semana', 
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana2/REFLEXION.mp3`, 
          prompts: [
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Esta semana vamos a entrenar un gesto muy sencillo pero poderoso: la micro-pausa. Ese pequeño respiro antes de responder es como abrir una ventana para dejar entrar aire fresco en medio del ruido del día.\nEn lugar de vivir en “piloto automático”, aprenderás a activar tu modo reflexivo —ese que te permite decidir con calma y claridad— para que tus elecciones nazcan de lo que valoras y no del miedo o la presión externa.\nDescubrirás también algo clave: cada vez que dices sí a lo urgente pero poco importante, en realidad estás diciendo no a lo que de verdad te importa. Ese “costo oculto” genera disonancia interna (“esto no encaja conmigo”), y la buena noticia es que se reduce en cuanto eliges coherencia con tus valores.\nPara practicarlo, trabajarás con dos herramientas exprés y muy prácticas:\n- Decisiones con dirección: un recurso rápido para detenerte, mirar y responder desde tu brújula personal.\n- Checklist del sentido: una guía breve para comprobar si tus microdecisiones diarias te acercan o te alejan de la vida que quieres construir.\nAl final de la semana habrás entrenado una nueva habilidad: dar menos “sí” automáticos y más “sí” con sentido.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana3/INTRODUCCIONSEMANA3.mp3` },
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana3/Vivirconsentido.mp3`,
          content: [
            {
              type: 'paragraph',
        ...
        { 
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana3tecnica1.mp3` 
        },
        { type: 'senseChecklistExercise', title: 'EJERCICIO 2: CHECKLIST DEL SENTIDO', objective: 'A veces tomamos decisiones sin pensar mucho… y luego nos sentimos incómodos o incómodas sin saber bien por qué.\nEste ejercicio es una especie de brújula interna rápida. Te va a servir para parar un momento antes de actuar y ver si lo que vas a hacer realmente encaja con lo que valoras.', duration: '5 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana3tecnica2.mp3` },
        ...
        { 
          type: 'therapeuticNotebookReflection', 
          title: 'Reflexión Final de la Semana', 
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana3/REFLEXION.mp3`, 
          prompts: [
        ...
        { type: 'title', text: 'Resumen Clave' },
        { type: 'paragraphWithAudio', text: '', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana3/RESUMEN.mp3` },
    ...
    {
      id: 'purpose_sem4',
      title: 'Semana 4: Crea tu Hoja de Ruta Personal',
      type: 'summary',
      estimatedTime: '15-20 min',
      content: [{ type: 'paragraphWithAudio', text: 'Tener un mapa es útil, pero lo que realmente te lleva a destino son los pasos que das cada día. Esta semana vamos a transformar tus valores —eso que de verdad te importa— en acciones concretas que caben en tu semana.\nVivir con propósito no significa descubrir una gran misión única, sino sostener pequeños hábitos con sentido que, repetidos, construyen la vida que deseas. Para ello, diseñarás tu hoja de ruta valiente con tres acciones reales y alcanzables, crearás un ancla visual que te recuerde lo esencial y entrenarás la flexibilidad para ajustar el rumbo cuando la vida cambie.\nLa ciencia lo respalda: actuar con propósito aumenta el bienestar, refuerza la resiliencia y reduce el ruido mental. En otras palabras, menos dispersión, más dirección.\nTu cierre de esta semana será un plan simple, vivo y completamente tuyo, pensado para que sigas avanzando sin prisa, pero con norte.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/INTRODUCCIONSEMANA4.mp3` },
        { type: 'title', text: 'Psicoeducación' },
        { type: 'collapsible', title: '¿Qué significa vivir con propósito?', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Quesignificavivirconproposito.mp3`, content: [{ type: 'paragraph', text: 'Muchas personas creen que tener propósito es descubrir una gran “misión de vida” o lograr un ideal de éxito. Pero en realidad, vivir con propósito significa avanzar con dirección interna: elegir desde lo que de verdad te importa y dar pasos que construyan sentido, incluso en lo pequeño.\nTu propósito es como una brújula: no te exige perfección, te orienta. Cuando lo sigues, experimentas más claridad, motivación y bienestar, incluso en medio de la incertidumbre.\nEsta semana no se trata de resolverlo todo, sino de empezar a elegir con más conciencia lo que sí quieres sostener en tu vida.' }] },
        { type: 'collapsible', title: 'Propósito, valores e identidad', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Propositovaloreseidentidad.mp3`, content: [{ type: 'paragraph', text: 'Cada decisión diaria puede ser un reflejo de tus valores: respeto, autenticidad, cuidado, justicia…\nCuando eliges en esa dirección:\n- Tu vida adquiere coherencia y sentido.\n- Tus acciones refuerzan tu identidad.\nPor ejemplo: si valoras la autenticidad y decides hablar con honestidad en una reunión, no solo actúas con coherencia, también refuerzas la idea de ti misma o ti mismo como alguien genuino.\nJames Clear (2018) lo describe así: “No somos lo que decimos que valoramos, sino lo que elegimos sostener cada día, incluso en lo pequeño”.' }] },
        { type: 'collapsible', title: 'Metas con sentido: claridad sin rigidez', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Metasconsentidoclaridadsinrigidez.mp3`, content: [{ type: 'paragraph', text: 'Tener metas claras ayuda a que tu propósito no quede en teoría. Pero más importante que el destino es el camino: los sistemas y hábitos que sostienes.\n- Una meta sin pasos intermedios puede ser frustrante.\n- En cambio, un hábito diario —aunque sea simple— te acerca con constancia a la persona que quieres ser.\nPregunta práctica: ¿Este hábito que repito cada día me acerca o me aleja de la vida que quiero habitar?\nRecuerda: lo valioso no siempre es lo espectacular, sino lo sostenido y auténtico.' }] },
        { type: 'collapsible', title: 'Autoconciencia amable: conocerte sin juicio', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Autoconcienciaamableconocertesinjuicio.mp3`, content: [{ type: 'paragraph', text: 'Tu propósito no se impone desde fuera, se descubre poco a poco desde dentro. Para ello necesitas pausas de reflexión y autoconciencia.\nPreguntas útiles:\n¿Qué quiero cuidar más en mi vida?\n¿Qué me da paz, orgullo o sentido?\n¿Qué patrones quiero dejar atrás?\nLa clave está en mirarte con curiosidad, no con juicio. Esta práctica, validada por la Terapia Cognitivo-Conductual y la Psicología Positiva (Neff, 2011; Ryan & Deci, 2020), mejora la autoestima y aumenta la autoeficacia: la sensación de que puedes influir en tu vida.' }] },
        { type: 'collapsible', title: 'Regulación emocional y flexibilidad vital', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Regulacionemocionalyflexibilidadvital.mp3`, content: [{ type: 'paragraph', text: 'Vivir con propósito no significa tener todo bajo control. Significa:\n- Regularte emocionalmente para responder desde lo que valoras, no desde el impulso.\n- Integrar el modo hacer (logros y objetivos) con el modo ser (presencia, descanso, conexión).\n- Aceptar cambios sin perder de vista lo que es importante para ti.\nEjemplo cotidiano: quizás tu valor es la salud y hoy no puedes hacer ejercicio intenso. Flexibilidad significa elegir una caminata suave sin sentir que has “fallado”.\nLa neurociencia muestra que una pausa consciente de respiración puede reducir la reactividad emocional y abrir espacio para decisiones más intencionales (Siegel, 2020).' }] },
        { type: 'collapsible', title: 'Responsabilidad y contribución', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Responsabilidadycontribucion.mp3`, content: [{ type: 'paragraph', text: 'El propósito también se fortalece cuando asumes la responsabilidad activa de tu vida: dejar de esperar a que lo externo cambie para empezar a actuar en coherencia contigo.\nAdemás, tu propósito crece cuando lo conectas con algo más grande que tú: tu comunidad, tu entorno, una causa que valoras.\nAcompañar, enseñar, cuidar o crear no solo ayuda a otros, también fortalece tu identidad y sentido de pertenencia.' }] },
        { type: 'collapsible', title: 'Decisiones, relaciones y energía con sentido', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Decisionesrelacionesyenergiaconsentido.mp3`, content: [{ type: 'paragraph', text: 'Cuando vives con propósito, notas cambios claros en tu día a día:\n- Tomas decisiones con más firmeza.\n- Tu energía se enfoca en lo importante, no en lo urgente.\n- Tu productividad mejora, no porque hagas más, sino porque haces lo que tiene sentido.\n- Tus relaciones se vuelven más auténticas y empáticas, porque eliges lo que quieres cuidar en ellas.\nEste vínculo entre propósito, bienestar y relaciones ha sido demostrado en estudios longitudinales (Hill & Turiano, 2014).' }] },
        { type: 'collapsible', title: 'Propósito como proceso, no como meta', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/Propositocomoprocesonocomometa.mp3`, content: [{ type: 'paragraph', text: 'Tu propósito no es algo que encuentras una vez y queda fijo. Es un proceso vivo, que se moldea con cada etapa de tu vida.\n- Puede redefinirse con nuevas experiencias.\n- Puede tomar distintas formas sin perder su esencia.\n- Ajustar el rumbo no es fracasar: es adaptarte desde lo que te importa.\nCierra esta semana recordando: “Vivir con propósito es recordar, cada día, que puedes ser autora o autor de tu historia.”' }] },
        { type: 'title', text: 'Técnicas Específicas' },
        { type: 'braveRoadmapExercise', title: 'EJERCICIO 1: MI HOJA DE RUTA VALIENTE', objective: 'Hoy vas a trazar tu propia hoja de ruta, con acciones que representen lo que valoras de verdad. \nQueremos ayudarte a pasar de la intención a la acción, con pasos sostenibles y valientes que te acerquen a tu propósito.', duration: '15-20 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana4tecnica1.mp3` },
        { type: 'essentialReminderExercise', title: 'EJERCICIO 2: MI RECORDATORIO ESENCIAL', objective: 'Con este ejercicio aprenderás a crear un ancla visual que te recuerde cada día qué valor quieres sostener y qué dirección quieres cultivar. Será tu brújula silenciosa.', duration: '10-15 min', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/tecnicas/Ruta7semana4tecnica2.mp3` },
        ...
        { 
          type: 'therapeuticNotebookReflection', 
          title: 'Reflexión Final de la Semana', 
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/REFLEXION.mp3`, 
          prompts: [
            '<p>Llega el momento de integrar lo aprendido con una reflexión personal; sin prisa. Mira dentro de ti y pon con palabras lo que ha cambiado</p>',
        ...
        { type: 'title', text: 'Resumen Clave' },
        { type: 'paragraphWithAudio', text: '', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/RESUMEN.mp3` },
        { type: 'list', items: ['Vivir con propósito no significa tenerlo todo claro, sino actuar desde lo que tiene sentido para ti.', 'Los valores son faros que guían tus decisiones y te ayudan a sentirte más conectada o conectado contigo misma/o.', 'Elegir acciones pequeñas, realistas y valientes te acerca a tu propósito sin abrumarte.', 'Crear un recordatorio visual es una forma práctica de mantener el rumbo cuando te dispersas.', 'Cuestionar tus pensamientos automáticos te da el poder de volver a elegir desde tu dirección interna.'] },
        { type: 'quote', text: 'No necesitas que todo esté claro para avanzar. Solo necesitas conectar con lo que te importa… y dar un paso valiente en esa dirección.3' }
      ]
    },
    {
      id: 'purpose_cierre',
      ...
      content: [
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/REFLEXIONRUTA7.mp3`,
          prompts: [
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/RESUMENFINALRUTA.mp3`
        },
        {
          type: 'list',
          items: [
        ...
        {
          type: 'quote',
          text: 'La claridad no siempre viene antes del movimiento. A veces aparece cuando decides caminar hacia lo que valoras.'
        }
      ]
    }
  ]
