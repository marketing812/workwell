  ...
  modules: [
    {
      ...
      content: [
...

        {
          ...
          objective:
            'A veces eliges callar para evitar conflictos o proteger un vínculo. Este ejercicio te ayudará a observar cuándo y por qué eliges no expresarte, para que esas decisiones sean más libres y menos automáticas.',
          duration: '15-20 min',
          audioUrl:
...

        {
          ...
          objective:
            'Este ejercicio te ayuda a entrenar esa conciencia: escuchar tus sensaciones físicas y emocionales como señales que te indican cuándo necesitas poner un límite.',
          duration: '10-15 min',
          audioUrl:
...

        {
          ...
          audioUrl:
            'https://workwellfut.com/audios/ruta4/descripciones/Audio9Ruta4Sesion1.mp3',
          prompts: [
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              type: 'collapsible',
              title:
                '3. Estilo Pasivo-Agresivo – “No lo digo, pero lo dejo caer”',
              audioUrl:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          objective:
            'Conectar con esa parte tuya que puede sostener un límite sin romperse, sin gritar, sin justificarse. Una parte firme, clara y tranquila.',
          duration: '5-8 min',
          audioUrl:
...
por favor, formatea las listas de este contenido