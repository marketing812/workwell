  ...
  modules: [
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: 'Resumen Clave',
          audioUrl:
            'https://workwellfut.com/audios/ruta4/descripciones/Audio10Ruta4Sesion1.mp3',
        },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        { 
          ...
          duration: '10-15 min', 
          audioUrl: 'https://workwellfut.com/audios/ruta4/tecnicas/Ruta4semana3audio5ejercicio1.mp3' 
        },
        {
          type: 'firmAndCalmSelfVisualizationExercise',
          title: 'Ejercicio 2: Visualización del Yo Firme y Tranquilo',
          objective: 'A veces, lo que necesitas no es más fuerza… sino más conexión contigo. Esta visualización te ayuda a conectar con esa parte tuya que puede sostener un límite sin romperse, sin gritar, sin justificarse. Una parte firme, clara y tranquila.',
    ...
    },
    {
      ...
      content: [{ type: 'therapeuticNotebookReflection', title: 'REFLEXIÓN FINAL DE LA RUTA PARA TU CUADERNO', audioUrl: 'https://workwellfut.com/audios/ruta4/descripciones/Reflexionsesion4ruta4.mp3', prompts: ['Has recorrido un camino valiente: el de poner límites con respeto, firmeza y cuidado. Tal vez no haya sido fácil. Quizás has tenido que enfrentar viejas culpas, miedos o dudas. Pero también has recuperado algo valioso: tu voz. Ahora te invito a hacer una pausa y mirar hacia dentro. No para exigirte más, sino para reconocer todo lo que ya has practicado. Escribe con honestidad y sin exigencias:','Preguntas para tu cuaderno emocional:','¿Qué me ha revelado esta ruta sobre mi forma de relacionarme?','¿Qué barreras me he atrevido a cruzar para ser más auténtico/a?','¿Qué quiero empezar a hacer diferente en mis relaciones?','¿Qué vínculo me gustaría cultivar desde un lugar más sano y más yo?','¿Qué me recordaré cuando sienta miedo de decepcionar por ser quien soy?']},
        { type: 'title', text: 'RESUMEN FINAL DE LA RUTA', audioUrl: 'https://workwellfut.com/audios/ruta4/descripciones/Resumenfinalruta4.mp3' },
        { type: 'list', items: ['Poner límites con respeto es un acto de honestidad, no de rechazo.','Las relaciones sanas resisten la claridad, incluso con desacuerdos.','No necesitas justificar tu “no” mil veces para que sea válido.','Validar la emoción del otro no implica ceder tu necesidad.','Sostener tu decisión sin culpa fortalece tu dignidad emocional.','Alejarte de vínculos que no respetan tus límites no es egoísmo, es autocuidado.','La coherencia entre lo que sientes, piensas y haces es el cimiento de relaciones auténticas.','El respeto hacia ti es una brújula: te muestra dónde quedarte, con quién reajustar, y de qué alejarte.']},
        { type: 'quote', text: '“Poner un límite no me aleja. Me acerca a lo que soy. \nY cada vez que lo hago con respeto, me convierto en un lugar seguro para mí mismo/a y para los demás.”' }
      ]
    }
  ]
};
