  ...
  modules: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'collapsible', title: 'Estilos de comunicación', audioUrl: 'https://workwellfut.com/audios/ruta4/descripciones/Audio4Ruta4Sesion2.mp3', content: [
        ...
        { type: 'noGuiltTechniquesExercise', title: 'Caja de herramientas extra: frases para decir "no" sin culpa', objective: 'Quiero ayudarte a sentir que tienes derecho a decir ‘no’ sin sentirte egoísta, brusco o culpable. Estas frases son como pequeñas llaves para cuidar tus límites sin romper el vínculo.', duration: '5-10 min por técnica' },
        { type: 'secureBoundaryPhraseExercise', title: 'Ejercicio 2: Tu Frase de "Límite Seguro"', objective: 'Tener una frase clara y amable preparada te puede salvar en situaciones incómodas. Este ejercicio te da recursos simples para no bloquearte, y para empezar a poner límites de forma serena y respetuosa.', duration: '5 minutos', audioUrl: 'https://workwellfut.com/audios/ruta4/tecnicas/Ruta4semana2audio8tecnica2.mp3' },
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'firmAndCalmSelfVisualizationExercise', title: 'Ejercicio 2: Visualización del Yo Firme y Tranquilo', objective: 'A veces, lo que necesitas no es más fuerza… sino más conexión contigo. Esta visualización te ayuda a conectar con esa parte tuya que puede sostener un límite sin romperse, sin gritar, sin justificarse. Una parte firme, clara y tranquila.', duration: '5–8 minutos', audioUrl: 'https://workwellfut.com/audios/rm/R4_visualizacion_del_yo_firme_y_tranquilo.mp3' },
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: 'https://workwellfut.com/audios/ruta4/descripciones/Audio7Ruta4Sesion3.mp3', prompts: ['Esta semana has aprendido que la incomodidad no siempre es señal de que te estás equivocando. A veces, el mayor crecimiento se siente raro, porque te estás atreviendo a hacer lo que nunca hiciste.','Te propongo cerrar con una pregunta:','¿Qué sensaciones aparecen en ti cuando mantienes un límite que antes habrías retirado?'] },
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          content: [
            { type: 'paragraph', text: 'A lo largo de esta ruta hemos aprendido qué es un límite, por qué cuesta ponerlo, cómo decirlo y cómo sostener la incomodidad que a veces aparece después. Ahora damos un paso más: poner límites no es solo un acto personal, también es un acto relacional. Porque cuando te atreves a ser claro o clara con lo que necesitas, no solo te cuidas tú… también le das al otro la oportunidad de conocerte de verdad.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            { type: 'paragraph', text: 'Al comenzar a poner límites, algo dentro de ti cambia… y eso también impacta en tus relaciones. No es un cambio pequeño: es como reordenar la forma en que te vinculas con los demás, te proteges y te haces visible. Dejas de responder automáticamente, y empiezas a elegir desde tu verdad. Eso mueve cosas.   Algo se mueve. Tus relaciones cambian. Algunas se vuelven más sanas. Otras… quizás se tensan. Es natural:   Las personas que te quieren bien agradecerán tu claridad, aunque al principio les sorprenda.   Las relaciones basadas en el control, la culpa o el desequilibrio pueden resistirse, porque estaban sostenidas por tu silencio o tu disponibilidad constante.   Esta semana no se trata solo de seguir practicando el “no”, sino de observar con conciencia qué relaciones merecen tu energía, cuáles necesitan un reajuste… y cuáles, tal vez, tu distancia.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            { type: 'paragraph', text: 'Cuando aprendemos a decir “no” con respeto, no estamos alejando al otro… estamos abriendo un espacio para que la relación se base en algo más real. Los límites, bien expresados, no cortan el vínculo: lo ordenan. Te muestran con claridad y ofrecen al otro una guía para cuidarte mejor.   Cuando expresas tus límites desde la calma y el respeto:   Le das al otro un mapa claro para relacionarse contigo.   Evitas malentendidos y resentimientos acumulados.   Creas espacio para vínculos más auténticos, donde tú también estás presente.   No todas las personas aceptarán tus límites con alegría. Pero quienes realmente te valoran, se adaptarán. El respeto mutuo no se basa en ceder siempre, sino en entenderse incluso cuando hay diferencias.' }
          ]
        },
        {
          type: 'collapsible',
          ...
          content: [
            { type: 'paragraph', text: 'Muchas veces, actuamos con buena intención… pero desde el miedo. Miedo a que el otro se enfade, se aleje o deje de querernos. Y ese miedo puede llevarte a silenciarte o a sostener más de lo que puedes. Esta ruta te invita a hacer una pausa honesta: ¿te estás eligiendo, o estás eligiendo agradar?   Una pregunta clave esta semana es:   ¿Estoy siendo yo… o estoy actuando para evitar el malestar del otro?   La complacencia a veces se disfraza de amabilidad, pero muchas veces nace del miedo:\n- Miedo al enfado del otro.\n- Miedo al conflicto.\n- Miedo a que me dejen de querer.\nCuando actúas desde ese lugar, tus relaciones pierden autenticidad… y tú te desgastas.   En cambio, cuando te expresas con firmeza y cuidado, fortaleces la confianza en ti… y das al otro la oportunidad de responder desde la suya.' }
          ]
        },
        {
          type: 'collapsible',
        ...
        },
        {
          ...
          content: [
            { type: 'paragraph', text: 'Poner límites no es solo decir “no”. Es también decidir dónde sí quieres estar, con quién sí quieres crecer, y cómo sí quieres vivir tus relaciones.   Las relaciones honestas no se construyen con perfección, sino con presencia.   Y cada vez que eliges no callarte, no forzarte, no desaparecer… estás entrenando una forma de quererte que también transforma el mundo que te rodea.' }
          ]
        },
        { type: 'title', text: 'Técnicas Específicas' },
      ...
      content: [
        {
          ...
          prompts: ["Has recorrido un camino valiente: el de poner límites con respeto, firmeza y cuidado. Tal vez no haya sido fácil. Quizás has tenido que enfrentar viejas culpas, miedos o dudas. Pero también has recuperado algo valioso: tu voz. Ahora te invito a hacer una pausa y mirar hacia dentro. No para exigirte más, sino para reconocer todo lo que ya has practicado. Escribe con honestidad y sin exigencias:","Preguntas para tu cuaderno emocional:","¿Qué me ha revelado esta ruta sobre mi forma de relacionarme?","¿Qué barreras me he atrevido a cruzar para ser más auténtico/a?","¿Qué quiero empezar a hacer diferente en mis relaciones?","¿Qué vínculo me gustaría cultivar desde un lugar más sano y más yo?","¿Qué me recordaré cuando sienta miedo de decepcionar por ser quien soy?"]
        },
        {
          type: 'title',
          text: 'RESUMEN FINAL DE LA RUTA',
          audioUrl:
            'https://workwellfut.com/audios/ruta4/descripciones/Resumenfinalruta4.mp3',
        },
        {
          type: 'list',
          items: [
