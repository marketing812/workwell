  ...
  modules: [
    {
      ...
      content: [
        ...
        { type: 'discomfortCompassExercise', title: 'Ejercicio 2: La Brújula del Malestar', objective: 'Este ejercicio te ayuda a entrenar esa conciencia: escuchar tus sensaciones físicas y emocionales como señales que te indican cuándo necesitas poner un límite.', duration: '10-15 min' },
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Técnicas Específicas' },
        { type: 'assertivePhraseExercise', title: 'Ejercicio 1: Tu Frase Asertiva en 4 Pasos', objective: 'A veces sabes que necesitas decir algo… pero no encuentras las palabras. Esta técnica te acompaña paso a paso para expresar lo que sientes, lo que necesitas y lo que pides, con claridad y respeto.', duration: '10-15 min'},
        { type: 'noGuiltTechniquesExercise', title: 'Ejercicio 2: Caja de herramientas extra: frases para decir "no" sin culpa', objective: 'Quiero ayudarte a sentir que tienes derecho a decir ‘no’ sin sentirte egoísta, brusco o culpable. Estas frases son como pequeñas llaves para cuidar tus límites sin romper el vínculo.', duration: '5-10 min por técnica' },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
         ...
         { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: "https://workwellfut.com/audios/ruta4/descripciones/Audio7Ruta4Sesion3.mp3", prompts: [
