  ...
  modules: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'collapsible',
          title: 'En resumen…',
          content: [{ type: 'list', items: ['La incertidumbre es parte de la vida, pero muchas veces la vivimos como amenaza.','Nuestro cuerpo y mente tienden a sobreprotegernos cuando sentimos que no tenemos el control.','La intolerancia a la incertidumbre se manifiesta en necesidad de control, rigidez y evitación.','No puedes controlar todo, pero puedes aprender a moverte con flexibilidad.','Diferenciar entre lo que depende de ti y lo que no, alivia la ansiedad y te devuelve poder.']}]
        },
    ...
    },
    {
      ...
      content: [
        ...
        { 
            ...
            content: [{ type: 'paragraph', text: 'A veces, tu cuerpo reacciona con ansiedad sin que haya pasado nada realmente peligroso. Solo hace falta un pensamiento como “¿Y si me equivoco?” o “¿Y si esto sale mal?” para que tu mente entre en bucle y tu cuerpo se ponga en alerta. \n\nEsto es lo que llamamos anticipación ansiosa: una forma de preocupación centrada en lo que podría pasar. Aunque sea solo imaginación, activa emociones, sensaciones y comportamientos como si el peligro fuera real. ' }] 
        },
        { 
            type: 'collapsible', 
        ...
        },
        {
          ...
          content: [
            ...
            { type: 'collapsible', title: 'Técnica 2: Respiración diafragmática (guiada paso a paso)', audioUrl: 'https://workwellfut.com/audios/rm/R1-parte-1-respiracion-muscular-progresiva.mp3', content: [{type: 'paragraph', text:'🌬️ Perfecta para reducir tensión acumulada o centrarte al empezar la jornada.'}] },
            { type: 'collapsible', title: 'Técnica 3: Anclaje sensorial inmediato (Técnica 5-4-3-2-1)', audioUrl: 'https://workwellfut.com/audios/R1_anclaje_sensorial_inmediato.m4a', content: [{type: 'paragraph', text:'🧠 Úsala cuando tu mente se inunde de pensamientos anticipatorios.'}] },
            { type: 'collapsible', title: 'Técnica 4: Escaneo corporal sin juicio (body scan)', audioUrl: 'https://workwellfut.com/audios/rm/R_body_scan_breve.mp3', content: [{type: 'paragraph', text:'🛏️ Útil para relajarte al final del día o facilitar el descanso.'}] },
            { type: 'collapsible', title: 'Técnica 5: Relajación muscular progresiva (Jacobson)', audioUrl: 'https://workwellfut.com/audios/rm/R1-parte-1-respiracion-muscular-progresiva.mp3', content: [{type: 'paragraph', text:'💪 Si sientes ansiedad física o mucha tensión corporal.'}] },
            { type: 'collapsible', title: 'Técnica 6: Técnicas de presión profunda y balanceo corporal', audioUrl: 'https://workwellfut.com/audios/rm/R16balanceocorporal.mp3', content: [{type: 'paragraph', text:'🤗 Especialmente útiles en momentos de desregulación intensa.'}] },
            { type: 'collapsible', title: 'Técnica 7: Contacto frío breve (reset inmediato)', audioUrl: 'https://workwellfut.com/audios/ruta13/tecnicas/Ruta13semana2tecnica20contactofrio.mp3', content: [{type: 'paragraph', text:'❄️ Interrumpe la activación emocional de forma rápida y directa.'}] },
          ]
        },
        {
        ...
        { 
          ...
          objective: 'Cuando anticipas lo peor, tu cuerpo reacciona como si ya estuvieras en peligro. Pero esa percepción no siempre es real. Este ejercicio te invita a hacerlo de forma segura y consciente.',
