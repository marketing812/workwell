...
export const uncertaintyPath: Path = {
  ...
  modules: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/semana2/porqueimaginamoslopeor.mp3`,
          content: [
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/semana2/comofuncionalaanticipacion.mp3`,
          content: [
            {
              type: 'paragraph',
              text: 'Desde la TCC y la neurociencia afectiva, sabemos que:\n\nLa preocupación es una cadena de pensamientos negativos sobre algo que normalmente no ha ocurrido, difíciles de controlar y que buscan prepararte para lo peor. Además, la preocupación te proporciona una falsa sensacion de control.\n\nPero en realidad, lo que consiguen estos pensamientos es activar el sistema de amenaza del cuerpo.\n\nEsto puede generar síntomas como palpitaciones, tensión, insomnio o dificultad para concentrarse, incluso sin que la situación temida haya ocurrido.'
            }
          ]
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/semana2/tesuenanestasideas.mp3`,
          content: [
            { type: 'paragraph', text: '“¿Y si digo algo ridículo en la reunión?”\n“¿Y si enfermo justo antes del viaje?”\n“¿Y si se decepcionan conmigo?”\n\nEstas frases no son inofensivas: cuando se repiten con frecuencia, entrenan a tu cuerpo para vivir en modo defensa constante.'}
          ]
        },
        {
          type: 'collapsible',
          title: 'Tu sistema de amenaza: entre el miedo y la percepción',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/Audio3Ruta2Sesion2.mp3`,
          content: [
            { type: 'paragraph', text: 'Nuestro sistema nervioso tiene una función adaptativa: protegernos ante lo que percibimos como peligroso. Pero el problema es que no distingue bien entre peligro real —algo que está sucediendo— y mental —algo que podría pasar—.\n\nCuando anticipas algo negativo, tu cuerpo entra en modo defensa:\n\nSe activa una zona del cerebro llamada amígdala, que funciona como una alarma interna.\n\nEsta activación acelera el corazón, tensa los músculos y prepara al cuerpo para reaccionar rápido.\n\nAl mismo tiempo, se apaga o bloquea parcialmente la zona del cerebro que te ayuda a pensar con claridad (la corteza prefrontal), porque el cuerpo prioriza la supervivencia, no la reflexión.\n\nEs decir: tu cuerpo reacciona al “¿y si…?” como si ya estuviera ocurriendo. Te sientes inquieto/a, alerta, con dificultad para concentrarte o calmarte. Todo esto nace de un pensamiento como, por ejemplo: “¿Y si no puedo con esto?”' }
          ]
        },
        {
          type: 'collapsible',
          title: '¿Qué activa mi sistema de amenaza?',
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/semana2/queactivamisistemadeamenaza.mp3`,
          content: [
            {
              type: 'paragraph',
              text: 'Cuando te sientes ansioso o en alerta sin un peligro real delante, es porque tu mente o tu sistema nervioso han interpretado algo como una posible amenaza. Esto puede ocurrir por varios motivos:'
            },
            {
              type: 'collapsible',
        ...
        },
        {
          ...
          audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/semana2/herramientaspararegular.mp3`,
          content: [
            {
              type: 'collapsible',
            ...
            },
            {
              ...
              content: [{
                type: 'list', items: [
                  ...
                  'Hacer espacio a lo que sientes, sin luchar ni forzarte a cambiarlo de inmediato.',
                  'Volver al cuerpo y al momento presente.'
                ]
              }]
            }
          ]
        ...
        { type: 'title', text: 'Técnicas Específicas'},
        { type: 'collapsible', title: 'Ejercicio 1: Calmar tu Cuerpo para Calmar tu Mente', content: [{ type: 'paragraphWithAudio', text: '¿Sientes que tu cuerpo se acelera cuando estás en tensión? Respirar más lento, mover el cuerpo o sentir el contacto con tu entorno puede ayudarte más de lo que imaginas.\n\nAquí encontrarás técnicas validadas por la ciencia para calmar tu sistema nervioso. Elige la que más te ayude y practica durante unos minutos.\nPuedes usarlas cuando notes ansiedad o como parte de tu rutina diaria.\n\nSi lo prefieres, activa el audio y déjate guiar.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/tecnicas/Ruta2sesion2audio6tecnica1.mp3` },{ type: 'collapsible', title: '¿Por qué estas técnicas funcionan?', content: []},{ type: 'collapsible', title: '¿Qué cambia cuando las practicas?', content: []},{ type: 'collapsible', title: '¿Cuándo puedes usarlas?', content: []},{ type: 'collapsible', title: 'Selección de técnicas', content: [{ type: 'collapsible', title: 'Técnica 1: Respiración 4–2–6 con gesto de autocuidado', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/rm/R1_respiracion_4-2-6.mp3`, content: [{ type: 'paragraph', text: 'Ideal antes de dormir o al comenzar el día. Inhala por la nariz durante 4 segundos. Mantén el aire 2 segundos. Exhala lentamente por la boca durante 6 segundos. Mientras respiras, coloca una mano sobre el pecho o el abdomen, como gesto de cuidado hacia ti. Practica esta respiración durante 1 o 2 minutos, varias veces al día o en momentos de tensión.'}]},{ type: 'collapsible', title: 'Técnica 2: Anclaje sensorial inmediato (Técnica 5-4-3-2-1)', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/R1_anclaje_sensorial_inmediato.m4a`, content: [{ type: 'paragraph', text: 'Úsala cuando tu mente se inunde de pensamientos anticipatorios.'}]},{ type: 'collapsible', title: 'Técnica 3: Escaneo corporal sin juicio (body scan)', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/rm/R_body_scan_breve.mp3`, content: [{ type: 'paragraph', text: 'Útil para relajarte al final del día o facilitar el descanso.'}]},{ type: 'collapsible', title: 'Técnica 4: Relajación muscular progresiva (Jacobson)', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/rm/R1-parte-1-respiracion-muscular-progresiva.mp3`, content: [{ type: 'paragraph', text: 'Si sientes ansiedad física o mucha tensión corporal.'}]},{ type: 'collapsible', title: 'Técnica 5: Técnicas de presión profunda y balanceo corporal', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/rm/R16balanceocorporal.mp3`, content: [{ type: 'paragraph', text: 'Especialmente útiles en momentos de desregulación intensa.'}]},{ type: 'collapsible', title: 'Técnica 6: Contacto frío breve (reset inmediato)', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana2tecnica20contactofrio.mp3`, content: [{ type: 'paragraph', text: 'Cómo aplicarlo:\n1.\tHumedece una toalla o paño con agua fría.\n2.\tAplícalo entre 10 y 20 segundos en:\n\to\tLa nuca\n\to\tLas muñecas\n\to\tLa parte interna de los brazos o las mejillas\n3.\tRespira mientras sientes el contacto del frío.\nSi estás fuera de casa, puedes usar agua del grifo o un cubito envuelto en tela.\nEste pequeño “shock” activa una respuesta calmante en tu cuerpo y te ayuda a pausar el bucle de ansiedad.'}]}]},{ type: 'therapeuticNotebookReflection', title: 'Registro de experiencia personal', prompts: ['¿Cómo te sentiste después de practicar alguna de estas técnicas? Escribe aquí tus palabras clave, sensaciones o una breve reflexión que quieras recordar:']}] },
        { type: 'exposureToIntoleranceExercise', title: 'Ejercicio 2: Pequeños Actos de Exposición a lo Incierto', objective: 'Entrénate para vivir con más calma, incluso cuando no tienes todas las respuestas, mediante la exposición segura y consciente a lo que no puedes controlar.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/tecnicas/Ruta2sesion2audio7tecnica2.mp3`, content: []},
        { type: 'therapeuticNotebookReflection', title: 'Reflexión Final de la Semana', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/Audio8Ruta2Sesion2.mp3`, prompts: ['<ul><li>¿Qué he aprendido sobre mi forma de reaccionar ante lo incierto?</li><li>¿Qué me ha ayudado más: calmarme antes, enfrentarme directamente o ambas cosas?</li><li>¿Qué tipo de pensamientos suelen aumentar mi ansiedad?</li><li>¿He notado algún cambio en cómo me siento al no tener el control total?</li><li>¿Qué quiero seguir practicando para fortalecer mi confianza ante lo incierto?</li></ul>']},
        { type: 'title', text: 'Resumen Clave de la Semana', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/Audio9Ruta2Sesion2.mp3`},
        ...
        { type: 'quote', text: 'No tienes que controlarlo todo para estar a salvo. Estoy aprendiendo a confiar, incluso en medio de lo incierto.'}
      ]
    },
    {
      ...
      content: [
        ...
        { type: 'title', text: 'Psicoeducación' },
        {
          ...
          content: [
            {
              type: 'paragraph',
              text: '¿Te ha pasado que sientes que solo hay una manera de ver las cosas? Como si tu mente se cerrara y te costara encontrar otras formas de entender lo que pasa.  Eso es rigidez cognitiva: cuando te cuesta adaptarte, cambiar de perspectiva o imaginar más de una posibilidad.   Es como tener una mente que solo acepta un camino, incluso cuando hay otros más seguros o adecuados. Todo parece blanco o negro, y cualquier cambio de plan genera incomodidad.\n\nTu cerebro tiene dos formas principales de procesar lo que ocurre: una rápida y automática, y otra más pausada y reflexiva. Ambas son útiles, pero cumplen funciones distintas.\n\nSistema 1: es la vía rápida\nFunciona en piloto automático, sin que lo pienses demasiado.  Es el que actúa cuando reaccionas de forma automatica, por instinto, te anticipas al peligro o interpretas las cosas de forma inmediata. Es emocional, veloz, y está muy influido por tus hábitos, experiencias pasadas y miedos. Te protege, pero a veces… se adelanta demasiado.\n\nCuando te riges solo por esta vía, puedes acabar atrapado/a en ideas como: “Esto va a salir mal”, “Necesito tenerlo todo claro ya”, “No puedo soportar la incertidumbre”\n\nSistema 2: es la vía lenta\nEntra en juego cuando paras, piensas, analizas y te das un momento para valorar diferentes opciones. Es más lógico, deliberado y consciente. Te permite tomar distancia del primer impulso y ver con más claridad lo que está pasando realmente.'
            }
          ]
        },
        {
    ...
    },
    {
      ...
      content: [{ type: 'therapeuticNotebookReflection', title: 'Reflexión final de la Ruta', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/Reflexionfinalruta2.mp3`, prompts: ['<p>Te proponemos cerrar este proceso con algunas preguntas clave:</p>','<ul>','<li>¿Qué he aprendido sobre mí al observar cómo vivo la incertidumbre?</li>','<li>¿Qué recursos internos he descubierto o fortalecido?</li>','<li>¿Qué nuevas formas de pensar o actuar quiero seguir practicando?</li>','<li>¿Qué quiero recordarme la próxima vez que el miedo al no saber aparezca?</li>','</ul>']},{ type: 'title', text: 'Resumen final de la Ruta', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta2/descripciones/Resumenfinalruta2.mp3`},{ type: 'list', items: ['La incertidumbre puede activar tu sistema de alerta, pero no tienes que vivir desde el miedo.','Comprender cómo funciona tu mente te ayuda a ganar claridad y no reaccionar de forma automática.','Tu cuerpo puede ser una brújula: calmarlo es una forma de recuperar el centro.','La rigidez mental intenta protegerte, pero limita tu capacidad de adaptación.','Entrenar la flexibilidad cognitiva te permite imaginar más de una historia y abrir nuevas posibilidades.','Confiar no es tener certezas, es avanzar con lo que tienes, desde donde estás.','Soltar el control no es rendirse, es un acto consciente de presencia y confianza.']},{ type: 'quote', text: 'No necesitas saber qué pasará mañana. Necesito recordar que hoy… puedo sostenerme.'}]
    }
  ]
};
