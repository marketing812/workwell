// src/data/assessmentDimensions.ts
...
export interface AssessmentItem {
  ...
  // OJO: esto es una copia estática del JSON que ya tienes en el PHP.
  // Lo uso sólo para que el build no rompa. Más abajo te explico cómo
  // ir sustituyendo esto por la llamada a la API.
