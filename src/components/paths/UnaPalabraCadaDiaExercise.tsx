...
export default function UnaPalabraCadaDiaExercise({ content, pathId, onComplete }: UnaPalabraCadaDiaExerciseProps) {
  ...
  const handleSave = () => {
    const finalEmotion = selectedEmotion === 'otra'
      ? otherEmotion
      : (unaPalabraEmotionOptions.find((e) => e.value === selectedEmotion)?.label || selectedEmotion);
        ...
        return (
          <div className="p-4 space-y-4">
            ...
            {selectedEmotion === 'otra' && (
              <Textarea value={otherEmotion} onChange={(e) => setOtherEmotion(e.target.value)} placeholder="Escribe tu emoción aquí..." className="mt-2" />
            )}
      ...
      case 4:
        return (
          <div className="p-4 text-center space-y-4">
            ...
            <p className="text-muted-foreground">Tu reflexión ha sido guardada en el cuaderno.</p>
          </div>
        );
      default:
        return null;
