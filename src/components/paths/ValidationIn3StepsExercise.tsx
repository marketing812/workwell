...
export default function ValidationIn3StepsExercise({
  content,
  pathId,
  onComplete,
}: ValidationIn3StepsExerciseProps) {
  ...
  const handleComplete = () => {
    if (step === 3 && (!blockageReflection.trim() || !nextStepReflection.trim())) {
      toast({
        ...
        description: "Por favor, completa ambos campos de reflexión.",
        variant: "destructive",
      });
      return;
    }
    ...
    const finalEmotion =
      perceivedEmotion === "otra" ? otherEmotion : t[perceivedEmotion as keyof typeof t] || perceivedEmotion;
...
Pregunta: ¿Qué podría empezar a hacer diferente para estar más presente? | Respuesta: ${nextStepReflection || "No especificado."}
    ...
    toast({
      title: "Ejercicio finalizado y guardado",
      description: "Has completado la práctica de Validación en 3 Pasos.",
    });
    setIsCompleted(true);
    onComplete();
  };
        ...
        return (
          <div className="p-4 space-y-4 animate-in fade-in-0 duration-500">
            ...
            <p className="text-sm text-muted-foreground">
              Piensa en una situación reciente en la que alguien te compartió algo con carga emocional. Trata de
              identificar qué sentía esa persona.
            </p>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="step1-phrase"
                value={step1Phrase}
                onChange={(e) => setStep1Phrase(e.target.value)}
                placeholder="Ej: Entiendo que estés triste..."
              />
            </div>
      ...
      case 1:
        return (
          <div className="p-4 space-y-4 animate-in fade-in-0 duration-500">
            ...
            <p className="text-sm text-muted-foreground">
              Conecta esa emoción con la situación que la generó. Usa esta fórmula como guía: "Entiendo que estés
              [emoción] porque [situación]".
            </p>
      ...
      case 2:
        return (
          <div className="p-4 space-y-4 animate-in fade-in-0 duration-500">
            ...
            <p className="text-sm text-muted-foreground">
              Elige una frase que le diga al otro: "Tu emoción tiene sentido en este contexto".
            </p>
      ...
      case 3:
        return (
          <div className="p-4 space-y-4 animate-in fade-in-0 duration-500">
            ...
            <p className="text-sm text-muted-foreground">
              A veces, sin querer, nos cuesta validar a los demás. Quizá por incomodidad, cansancio o automatismos
              aprendidos.
            </p>
            <div className="space-y-2">
              <Label htmlFor="blockage-reflection">
                ¿En qué situaciones me resulta más difícil validar emocionalmente a alguien?
              </Label>
              <Textarea
                id="blockage-reflection"
                value={blockageReflection}
                onChange={(e) => setBlockageReflection(e.target.value)}
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="next-step-reflection">
                ¿Qué podría empezar a hacer diferente para estar más presente?
              </Label>
              <Textarea
                id="next-step-reflection"
                value={nextStepReflection}
        ...
        {!isCompleted ? (
          ...
          <div className="p-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Cuando validas, no estás diciendo "tienes razón", estás diciendo: "lo que sientes importa y estoy aquí
              contigo".
            </p>
          </div>
        )}
