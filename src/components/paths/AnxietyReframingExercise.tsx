          ...
          <div className="space-y-6 p-2">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <h4 className="font-normal">¿Qué he descubierto sobre la manera en que mi mente anticipa y exagera escenarios?</h4>
                <Textarea id="q1" value={responses.q1} onChange={(e) => handleChange('q1', e.target.value)} disabled={isSaved} />
              </div>
              <div className="space-y-2">
                <h4 className="font-normal">¿Qué me pasa cuando confundo posibilidad con probabilidad? ¿Qué efecto tiene en mis decisiones?</h4>
                <Textarea id="q2" value={responses.q2} onChange={(e) => handleChange('q2', e.target.value)} disabled={isSaved} />
              </div>
              <div className="space-y-2">
                <h4 className="font-normal">¿Qué me ha servido más para tomar distancia de los pensamientos: la técnica STOP, el cuestionamiento de “¿y si…?” u otra estrategia personal?</h4>
                <Textarea id="q3" value={responses.q3} onChange={(e) => handleChange('q3', e.target.value)} disabled={isSaved} />
              </div>
              <div className="space-y-2">
                <h4 className="font-normal">¿Qué compromiso quiero llevarme para el futuro cuando aparezca la ansiedad? (ejemplo: “darme una pausa y observar antes de reaccionar”)</h4>
