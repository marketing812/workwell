...
// RUTA 1
const StressMapExercise = dynamic(() => import('@/components/paths/StressMapExercise').then(mod => mod.StressMapExercise), { loading: LoaderComponent, ssr: false });
const TriggerExercise = dynamic(() => import('@/components/paths/TriggerExercise').then(mod => mod.TriggerExercise), { loading: LoaderComponent, ssr: false });
const DetectiveExercise = dynamic(() => import('@/components/paths/DetectiveExercise').then(mod => mod.DetectiveExercise), { loading: LoaderComponent, ssr: false });
const DemandsExercise = dynamic(() => import('@/components/paths/DemandsExercise').then(mod => mod.DemandsExercise), { loading: LoaderComponent, ssr: false });
const WellbeingPlanExercise = dynamic(() => import('@/components/paths/WellbeingPlanExercise').then(mod => mod.WellbeingPlanExercise), { loading: LoaderComponent, ssr: false });
// RUTA 2
const UncertaintyMapExercise = dynamic(() => import('@/components/paths/UncertaintyMapExercise').then(mod => mod.UncertaintyMapExercise), { loading: LoaderComponent, ssr: false });
...
const MicroPlanExercise = dynamic(() => import('@/components/paths/MicroPlanExercise').then(mod => mod.MicroPlanExercise), { loading: LoaderComponent, ssr: false });
const FutureSelfVisualizationExercise = dynamic(() => import('@/components/paths/FutureSelfVisualizationExercise').then(mod => mod.FutureSelfVisualizationExercise), { loading: LoaderComponent, ssr: false });
const RealisticRitualExercise = dynamic(() => import('@/components/paths/RealisticRitualExercise').then(mod => mod.RealisticRitualExercise), { loading: LoaderComponent, ssr: false });
const GentleTrackingExercise = dynamic(() => import('@/components/paths/GentleTrackingExercise').then(mod => mod.GentleTrackingExercise), { loading: LoaderComponent, ssr: false });
const BlockageMapExercise = dynamic(() => import('@/components/paths/BlockageMapExercise').then(mod => mod.BlockageMapExercise), { loading: LoaderComponent, ssr: false });
const CompassionateReflectionExercise = dynamic(() => import('@/components/paths/CompassionateReflectionExercise').then(mod => mod.CompassionateReflectionExercise), { loading: LoaderComponent, ssr: false });
// RUTA 4
const MapOfUnsaidThingsExercise = dynamic(() => import('@/components/paths/MapOfUnsaidThingsExercise').then(mod => mod.MapOfUnsaidThingsExercise), { loading: LoaderComponent, ssr: false });
...
// RUTA 5
const AuthenticityThermometerExercise = dynamic(() => import('@/components/paths/AuthenticityThermometerExercise').then(mod => mod.AuthenticityThermometerExercise), { loading: LoaderComponent, ssr: false });
const EmpatheticDialogueExercise = dynamic(() => import('@/components/paths/EmpatheticDialogueExercise').then(mod => mod.EmpatheticDialogueExercise), { loading: LoaderComponent, ssr: false });
const EmpathicMirrorExercise = dynamic(() => import('@/components/paths/EmpathicMirrorExercise').then(mod => mod.EmpathicMirrorExercise), { loading: LoaderComponent, ssr: false });
const ValidationIn3StepsExercise = dynamic(() => import('@/components/paths/ValidationIn3StepsExercise').then(mod => mod.ValidationIn3StepsExercise), { loading: LoaderComponent, ssr: false });
const EmpathicShieldVisualizationExercise = dynamic(() => import('@/components/paths/EmpathicShieldVisualizationExercise').then(mod => mod.EmpathicShieldVisualizationExercise), { loading: LoaderComponent, ssr: false });
const EmotionalInvolvementTrafficLightExercise = dynamic(() => import('@/components/paths/EmotionalInvolvementTrafficLightExercise').then(mod => mod.EmotionalInvolvementTrafficLightExercise), { loading: LoaderComponent, ssr: false });
const SignificantRelationshipsInventoryExercise = dynamic(() => import('@/components/paths/SignificantRelationshipsInventoryExercise').then(mod => mod.SignificantRelationshipsInventoryExercise), { loading: LoaderComponent, ssr: false });
const RelationalCommitmentExercise = dynamic(() => import('@/components/paths/RelationalCommitmentExercise').then(mod => mod.RelationalCommitmentExercise), { loading: LoaderComponent, ssr: false });
// RUTA 6
const DetectiveDeEmocionesExercise = dynamic(() => import('@/components/paths/DetectiveDeEmocionesExercise').then(mod => mod.DetectiveDeEmocionesExercise), { loading: LoaderComponent, ssr: false });
const UnaPalabraCadaDiaExercise = dynamic(() => import('@/components/paths/UnaPalabraCadaDiaExercise').then(mod => mod.UnaPalabraCadaDiaExercise), { loading: LoaderComponent, ssr: false });
const MapaEmocionNecesidadCuidadoExercise = dynamic(() => import('@/components/paths/MapaEmocionNecesidadCuidadoExercise').then(mod => mod.MapaEmocionNecesidadCuidadoExercise), { loading: LoaderComponent, ssr: false });
const CartaDesdeLaEmocionExercise = dynamic(() => import('@/components/paths/CartaDesdeLaEmocionExercise').then(mod => mod.CartaDesdeLaEmocionExercise), { loading: LoaderComponent, ssr: false });
const MapaEmocionalRepetidoExercise = dynamic(() => import('@/components/paths/MapaEmocionalRepetidoExercise').then(mod => mod.MapaEmocionalRepetidoExercise), { loading: LoaderComponent, ssr: false });
const SemaforoEmocionalExercise = dynamic(() => import('@/components/paths/SemaforoEmocionalExercise').then(mod => mod.SemaforoEmocionalExercise), { loading: LoaderComponent, ssr: false });
const MeditacionGuiadaSinJuicioExercise = dynamic(() => import('@/components/paths/MeditacionGuiadaSinJuicioExercise').then(mod => mod.MeditacionGuiadaSinJuicioExercise), { loading: LoaderComponent, ssr: false });
const DiarioMeDiCuentaExercise = dynamic(() => import('@/components/paths/DiarioMeDiCuentaExercise').then(mod => mod.DiarioMeDiCuentaExercise), { loading: LoaderComponent, ssr: false });
// RUTA 7
...
const SenseChecklistExercise = dynamic(() => import('@/components/paths/SenseChecklistExercise').then(mod => mod.SenseChecklistExercise), { loading: LoaderComponent, ssr: false });
const UnfulfilledNeedsExercise = dynamic(() => import('@/components/paths/UnfulfilledNeedsExercise').then(mod => mod.UnfulfilledNeedsExercise), { loading: LoaderComponent, ssr: false });
const BraveRoadmapExercise = dynamic(() => import('@/components/paths/BraveRoadmapExercise').then(mod => mod.BraveRoadmapExercise), { loading: LoaderComponent, ssr: false });
const EssentialReminderExercise = dynamic(() => import('@/components/paths/EssentialReminderExercise').then(mod => mod.EssentialReminderExercise), { loading: LoaderComponent, ssr: false });
const ThoughtsThatBlockPurposeExercise = dynamic(() => import('@/components/paths/ThoughtsThatBlockPurposeExercise').then(mod => mod.ThoughtsThatBlockPurposeExercise), { loading: LoaderComponent, ssr: false });
// RUTA 8
const ResilienceTimelineExercise = dynamic(() => import('@/components/paths/ResilienceTimelineExercise').then(mod => mod.ResilienceTimelineExercise), { loading: LoaderComponent, ssr: false });
const PersonalDefinitionExercise = dynamic(() => import('@/components/paths/PersonalDefinitionExercise').then(mod => mod.PersonalDefinitionExercise), { loading: LoaderComponent, ssr: false });
const AnchorInStormExercise = dynamic(() => import('@/components/paths/AnchorInStormExercise').then(mod => mod.AnchorInStormExercise), { loading: LoaderComponent, ssr: false });
const IntensityScaleExercise = dynamic(() => import('@/components/paths/IntensityScaleExercise').then(mod => mod.IntensityScaleExercise), { loading: LoaderComponent, ssr: false });
const BraveDecisionsWheelExercise = dynamic(() => import('@/components/paths/BraveDecisionsWheelExercise').then(mod => mod.BraveDecisionsWheelExercise), { loading: LoaderComponent, ssr: false });
const PlanABExercise = dynamic(() => import('@/components/paths/PlanABExercise').then(mod => mod.PlanABExercise), { loading: LoaderComponent, ssr: false });
const ChangeTimelineExercise = dynamic(() => import('@/components/paths/ChangeTimelineExercise').then(mod => mod.ChangeTimelineExercise), { loading: LoaderComponent, ssr: false });
const MyPactExercise = dynamic(() => import('@/components/paths/MyPactExercise').then(mod => mod.MyPactExercise), { loading: LoaderComponent, ssr: false });
// RUTA 9
const CoherenceCompassExercise = dynamic(() => import('@/components/paths/CoherenceCompassExercise').then(mod => mod.CoherenceCompassExercise), { loading: LoaderComponent, ssr: false });
const SmallDecisionsLogExercise = dynamic(() => import('@/components/paths/SmallDecisionsLogExercise').then(mod => mod.SmallDecisionsLogExercise), { loading: LoaderComponent, ssr: false });
const InternalTensionsMapExercise = dynamic(() => import('@/components/paths/InternalTensionsMapExercise').then(mod => mod.InternalTensionsMapExercise), { loading: LoaderComponent, ssr: false });
const EthicalMirrorExercise = dynamic(() => import('@/components/paths/EthicalMirrorExercise').then(mod => mod.EthicalMirrorExercise), { loading: LoaderComponent, ssr: false });
const IntegrityDecisionsExercise = dynamic(() => import('@/components/paths/IntegrityDecisionsExercise').then(mod => mod.IntegrityDecisionsExercise), { loading: LoaderComponent, ssr: false });
const NonNegotiablesExercise = dynamic(() => import('@/components/paths/NonNegotiablesExercise').then(mod => mod.NonNegotiablesExercise), { loading: LoaderComponent, ssr: false });
const EnvironmentEvaluationExercise = dynamic(() => import('@/components/paths/EnvironmentEvaluationExercise').then(mod => mod.EnvironmentEvaluationExercise), { loading: LoaderComponent, ssr: false });
const PersonalManifestoExercise = dynamic(() => import('@/components/paths/PersonalManifestoExercise').then(mod => mod.PersonalManifestoExercise), { loading: LoaderComponent, ssr: false });
// RUTA 10
const ComplaintTransformationExercise = dynamic(() => import('@/components/paths/ComplaintTransformationExercise').then(mod => mod.ComplaintTransformationExercise), { loading: LoaderComponent, ssr: false });
const GuiltRadarExercise = dynamic(() => import('@/components/paths/GuiltRadarExercise').then(mod => mod.GuiltRadarExercise), { loading: LoaderComponent, ssr: false });
const AcceptanceWritingExercise = dynamic(() => import('@/components/paths/AcceptanceWritingExercise').then(mod => mod.AcceptanceWritingExercise), { loading: LoaderComponent, ssr: false });
const SelfAcceptanceAudioExercise = dynamic(() => import('@/components/paths/SelfAcceptanceAudioExercise').then(mod => mod.SelfAcceptanceAudioExercise), { loading: LoaderComponent, ssr: false });
const CompassionateResponsibilityContractExercise = dynamic(() => import('@/components/paths/CompassionateResponsibilityContractExercise').then(mod => mod.CompassionateResponsibilityContractExercise), { loading: LoaderComponent, ssr: false });
const CriticismToGuideExercise = dynamic(() => import('@/components/paths/CriticismToGuideExercise').then(mod => mod.CriticismToGuideExercise), { loading: LoaderComponent, ssr: false });
const InfluenceWheelExercise = dynamic(() => import('@/components/paths/InfluenceWheelExercise').then(mod => mod.InfluenceWheelExercise), { loading: LoaderComponent, ssr: false });
...
const SupportBankExercise = dynamic(() => import('@/components/paths/SupportBankExercise').then(mod => mod.SupportBankExercise), { loading: LoaderComponent, ssr: false });
const MutualCareCommitmentExercise = dynamic(() => import('@/components/paths/MutualCareCommitmentExercise').then(mod => mod.MutualCareCommitmentExercise), { loading: LoaderComponent, ssr: false });
const SymbolicSupportCircleExercise = dynamic(() => import('@/components/paths/SymbolicSupportCircleExercise').then(mod => mod.SymbolicSupportCircleExercise), { loading: LoaderComponent, ssr: false });
// RUTA 12
const EmotionalGratificationMapExercise = dynamic(() => import('@/components/paths/EmotionalGratificationMapExercise').then(mod => mod.EmotionalGratificationMapExercise), { loading: LoaderComponent, ssr: false });
const DailyEnergyCheckExercise = dynamic(() => import('@/components/paths/DailyEnergyCheckExercise').then(mod => mod.DailyEnergyCheckExercise), { loading: LoaderComponent, ssr: false });
const DailyWellbeingPlanExercise = dynamic(() => import('@/components/paths/DailyWellbeingPlanExercise').then(mod => mod.DailyWellbeingPlanExercise), { loading: LoaderComponent, ssr: false });
const MorningRitualExercise = dynamic(() => import('@/components/paths/MorningRitualExercise').then(mod => mod.MorningRitualExercise), { loading: LoaderComponent, ssr: false });
const MotivationIn3LayersExercise = dynamic(() => import('@/components/paths/MotivationIn3LayersExercise').then(mod => mod.MotivationIn3LayersExercise), { loading: LoaderComponent, ssr: false });
const VisualizeDayExercise = dynamic(() => import('@/components/paths/VisualizeDayExercise').then(mod => mod.VisualizeDayExercise), { loading: LoaderComponent, ssr: false });
...
// RUTA 13 (NUEVA)
const AnsiedadTieneSentidoExercise = dynamic(() => import('@/components/paths/AnsiedadTieneSentidoExercise').then(mod => mod.AnsiedadTieneSentidoExercise), { loading: LoaderComponent, ssr: false });
const VisualizacionGuiadaCuerpoAnsiedadExercise = dynamic(() => import('@/components/paths/VisualizacionGuiadaCuerpoAnsiedadExercise').then(mod => mod.VisualizacionGuiadaCuerpoAnsiedadExercise), { loading: LoaderComponent, ssr: false });
const StopExercise = dynamic(() => import('@/components/paths/StopExercise').then(mod => mod.StopExercise), { loading: LoaderComponent, ssr: false });
