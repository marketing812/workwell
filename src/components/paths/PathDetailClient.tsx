...
// RUTA 1
const StressMapExercise = dynamic(() => import('@/components/paths/StressMapExercise').then(mod => mod.default), { loading: LoaderComponent, ssr: false });
const TriggerExercise = dynamic(() => import('@/components/paths/TriggerExercise').then(mod => mod.default), { loading: LoaderComponent, ssr: false });
const DetectiveExercise = dynamic(() => import('@/components/paths/DetectiveExercise').then(mod => mod.default), { loading: LoaderComponent, ssr: false });
