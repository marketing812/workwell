      ...
      case 1: 
        return (
          <div className="p-4 space-y-4">
            ...
            <audio key="audio-step-1" controls controlsList="nodownload" className="w-full mt-2"><source src={`${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/R13sem3tecnica2primerpaso.mp3`} type="audio/mpeg" /></audio>
      ...
      case 2: 
        return (
          <div className="p-4 space-y-4">
            ...
            <audio key="audio-step-2" controls controlsList="nodownload" className="w-full mt-2"><source src={`${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/R13sem3tecnica2segundopaso.mp3`} type="audio/mpeg" /></audio>
      ...
      case 3: 
        return (
          <div className="p-4 space-y-4">
            ...
            <audio key="audio-step-3" controls controlsList="nodownload" className="w-full mt-2"><source src={`${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/R13sem3tecnica2paso3.mp3`} type="audio/mpeg" /></audio>
        ...
        <CardDescription className="pt-2">
            ...
            <div className="mt-4">
              <audio controls controlsList="nodownload" className="w-full">
                  <source src={`${EXTERNAL_SERVICES_BASE_URL}/audios/ruta13/tecnicas/Ruta13semana3tecnica2.mp3`} type="audio/mpeg" />
