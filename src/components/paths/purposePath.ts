  ...
  modules: [
    ...
    },
    {
      ...
      content: [{ type: 'paragraphWithAudio', text: 'Tener un mapa es útil, pero lo que realmente te lleva a destino son los pasos que das cada día. Esta semana vamos a transformar tus valores —eso que de verdad te importa— en acciones concretas que caben en tu semana.\nVivir con propósito no significa descubrir una gran misión única, sino sostener pequeños hábitos con sentido que, repetidos, construyen la vida que deseas. Para ello, diseñarás tu hoja de ruta valiente con tres acciones reales y alcanzables, crearás un ancla visual que te recuerde lo esencial y entrenarás la flexibilidad para ajustar el rumbo cuando la vida cambie.\nLa ciencia lo respalda: actuar con propósito aumenta el bienestar, refuerza la resiliencia y reduce el ruido mental. En otras palabras, menos dispersión, más dirección.\nTu cierre de esta semana será un plan simple, vivo y completamente tuyo, pensado para que sigas avanzando sin prisa, pero con norte.', audioUrl: `${EXTERNAL_SERVICES_BASE_URL}/audios/ruta7/descripciones/semana4/INTRODUCCIONSEMANA4.mp3` },
        ...
        { type: 'quote', text: 'No necesitas que todo esté claro para avanzar. Solo necesitas conectar con lo que te importa… y dar un paso valiente en esa dirección.1' }
      ]
    },
    {
      id: 'purpose_cierre',
