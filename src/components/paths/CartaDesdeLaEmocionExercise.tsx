...
export default function CartaDesdeLaEmocionExercise({
  content,
  pathId,
  onComplete,
}: CartaDesdeLaEmocionExerciseProps) {
...
Tu emoción: ${finalEmotion}
    ...
    addNotebookEntry({
      title: `Carta desde mi ${finalEmotion}`,
      content: fullLetter,
      pathId,
      userId: user?.id,
    });
        ...
        return (
          <div className="p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Imagina que hay una parte dentro de ti que siente algo muy intensamente... y quiere expresarse. ¿Qué
              emoción te está pidiendo ser escuchada hoy?
            </p>
            ...
            {emotion === 'otra' && (
              <Textarea
                ...
                placeholder="Describe tu emoción aquí..."
              />
            )}

            <Button onClick={() => setStep(1)} className="w-full mt-2" disabled={!finalEmotion.trim()}>
        ...
        return (
          <div className="p-4 space-y-4">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                Según la emoción que elijas, puedes seleccionar un estilo de carta que te ayude a conectar mejor con
                lo que sientes. Imagina:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Tristeza: Voz compasiva y suave</li>
                <li>Ira: Voz clara, firme y directa</li>
                <li>Ansiedad: Voz serena y tranquilizadora</li>
                <li>Culpa: Voz amable y reparadora</li>
                <li>Otra emoción: Elige el tono que más te ayude</li>
              </ul>
            </div>
            ...
            <Select value={tone} onValueChange={setTone}>
              ...
              <SelectContent>
                <SelectItem value="compasivo">Compasivo y suave</SelectItem>
                <SelectItem value="firme">Claro, firme y directo</SelectItem>
                <SelectItem value="sereno">Sereno y tranquilizador</SelectItem>
                <SelectItem value="otra">Otra...</SelectItem>
              </SelectContent>
            </Select>
            ...
            {tone === 'otra' && (
              <Textarea
                value={otherTone}
                onChange={(event) => setOtherTone(event.target.value)}
            ...
            <div className="flex justify-between mt-2">
              ...
              <Button onClick={() => setStep(2)} className="w-auto">
                Siguiente <ArrowRight className="mr-2 h-4 w-4" />
              </Button>
            </div>
          </div>
      ...
      case 2:
        return (
          <div className="p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Ahora deja que tu emoción escriba. No tienes que pensarlo demasiado. Solo deja que salga con sinceridad.
            </p>

            <div className="p-4 border rounded-md bg-background/50 space-y-4 text-sm">
              <p>
                Hola, soy tu emoción: <strong>{finalEmotion}</strong>
              </p>
              ...
              <div className="space-y-1">
                ...
                <Textarea
                  ...
                  placeholder="Ej: seguridad, calma, respeto..."
                />
              </div>

              <p>
                No vengo a hacerte daño. Estoy aquí para ayudarte a mirar hacia dentro. Quiero que sepas que te estoy
                protegiendo, aunque a veces no sepa cómo expresarme.
              </p>
              <p>
                Me gustaría que me escucharas sin miedo. Solo necesito un espacio para ser vista, sentida y
                comprendida.
              </p>
              ...
              <p>Con cariño,</p>
              <p>
                Tu emoción: <strong>{finalEmotion}</strong>
              </p>
            </div>

            <p className="text-sm text-muted-foreground text-center">
              Recuerda: No tienes que escribir una carta perfecta. Solo deja que tu emoción se exprese tal y como lo
              harías con alguien que te importa de verdad: tú.
            </p>

            <p className="text-xs text-muted-foreground italic text-center">
              Puedes guardar esta carta en tu Cuaderno Terapéutico, así podrás volver a leerla cuando lo necesites,
            ...
            <div className="flex justify-between mt-2">
              ...
              <Button onClick={handleSave} className="w-auto" disabled={!need.trim()}>
                ...
                Guardar carta en el Cuaderno Terapéutico
              </Button>
            </div>
          </div>
        );
