            ...
            case 0: // Intro
                return (
                    <div className="p-4 space-y-4 text-center">
                        <p className="text-sm text-muted-foreground">{content.objective}</p><p className="text-sm text-muted-foreground">Con esta técnica vas a entrenar a tu mente para equilibrar esa balanza. En lugar de quedarte solo o sola con los fallos y dificultades, aprenderás a capturar y conservar los momentos que te nutren. Hacerlo no solo te ayudará a revivir emociones agradables en los días complicados, sino que también fortalecerá tu resiliencia, aumentará tu motivación y te dará calma interior. Piensa en esto como en crear un álbum secreto de bienestar: una galería personal con recuerdos valiosos que siempre estarán disponibles para ti. Cada vez que la visites, será como abrir una ventana de luz en medio de un día nublado.</p>
    ...
    return (
        <Card className="bg-muted/30 my-6 shadow-md">
            <CardHeader>
                ...
                {(content.objective || content.audioUrl) && (
